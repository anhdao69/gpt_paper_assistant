...
0. [Multimodal OCR: Parse Anything from Documents](#link0)
...
1. [V-Bridge: Bridging Video Generative Priors to Versatile Few-shot Image Restoration](#link1)
**Authors:** Shenghe Zheng, Junpeng Jiang, Wenbo Li

2. [ESPIRE: A Diagnostic Benchmark for Embodied Spatial Reasoning of Vision-Language Models](#link2)
**Authors:** Yanpeng Zhao, Wentao Ding, Hongtao Li, Baoxiong Jia, Zilong Zheng

3. [PVI: Plug-in Visual Injection for Vision-Language-Action Models](#link3)
...
4. [SPARROW: Learning Spatial Precision and Temporal Referential Consistency in Pixel-Grounded Video MLLMs](#link4)
**Authors:** Mohamad Alansari, Naufal Suryanto, Divya Velayudhan, Sajid Javed, Naoufel Werghi, Muzammal Naseer

5. [Towards Spatio-Temporal World Scene Graph Generation from Monocular Videos](#link5)
**Authors:** Rohith Peddi, Saurabh, Shravan Shanmugam, Likhitha Pallapothula, Yu Xiang, Parag Singla, Vibhav Gogate

6. [Cheers: Decoupling Patch Details from Semantic Representations Enables Unified Multimodal Comprehension and Generation](#link6)
...
7. [Test-Time Attention Purification for Backdoored Large Vision Language Models](#link7)
**Authors:** Zhifang Zhang, Bojun Yang, Shuo He, Weitong Chen, Wei Emma Zhang, Olaf Maennel, Lei Feng, Miao Xu

8. [VFM-Recon: Unlocking Cross-Domain Scene-Level Neural Reconstruction with Scale-Aligned Foundation Priors](#link8)
**Authors:** Yuhang Ming, Tingkang Xi, Xingrui Yang, Lixin Yang, Yong Peng, Cewu Lu, Wanzeng Kong

9. [MemRoPE: Training-Free Infinite Video Generation via Evolving Memory Tokens](#link9)
**Authors:** Youngrae Kim, Qixin Hu, C. -C. Jay Kuo, Peter A. Beerel

10. [Thinking in Dynamics: How Multimodal Large Language Models Perceive, Track, and Reason Dynamics in Physical 4D World](#link10)
...
11. [Composing Driving Worlds through Disentangled Control for Adversarial Scenario Generation](#link11)
...
12. [Finite Difference Flow Optimization for RL Post-Training of Text-to-Image Models](#link12)
**Authors:** David McAllister, Miika Aittala, Tero Karras, Janne Hellsten, Angjoo Kanazawa, Timo Aila, Samuli Laine

13. [SAW: Toward a Surgical Action World Model via Controllable and Scalable Video Generation](#link13)
...
14. [Generalized Recognition of Basic Surgical Actions Enables Skill Assessment and Vision-Language-Model-based Surgical Planning](#link14)
...
15. [SAP: Segment Any 4K Panorama](#link15)
...
16. [A Closed-Form Solution for Debiasing Vision-Language Models with Utility Guarantees Across Modalities and Tasks](#link16)
**Authors:** Tangzheng Lian, Guanyu Hu, Yijing Ren, Dimitrios Kollias, Oya Celiktutan

17. [AVION: Aerial Vision-Language Instruction from Offline Teacher to Prompt-Tuned Network](#link17)
**Authors:** Yu Hu, Jianyang Gu, Hao Liu, Yue Cao, Jozsef Hamari, Zheng Liu, Mohsen Zardadi

18. [MRGeo: Robust Cross-View Geo-Localization of Corrupted Images via Spatial and Channel Feature Enhancement](#link18)
**Authors:** Le Wu, Lv Bo, Songsong Ouyang, Yingying Zhu

19. [FedBPrompt: Federated Domain Generalization Person Re-Identification via Body Distribution Aware Visual Prompts](#link19)
**Authors:** Xin Xu, Weilong Li, Wei Liu, Wenke Huang, Zhixi Yu, Bin Yang, Xiaoying Liao, Kui Jiang

20. [InterEdit: Navigating Text-Guided Multi-Human 3D Motion Editing](#link20)
...
21. [Mitigating Memorization in Text-to-Image Diffusion via Region-Aware Prompt Augmentation and Multimodal Copy Detection](#link21)
**Authors:** Yunzhuo Chen, Jordan Vice, Naveed Akhtar, Nur Al Hasan Haldar, Ajmal Mian

22. [NOIR: Neural Operator mapping for Implicit Representations](#link22)
**Authors:** Sidaty El Hadramy, Nazim Haouchine, Michael Wehrli, Philippe C. Cattin

23. [ToolTree: Efficient LLM Agent Tool Planning via Dual-Feedback Monte Carlo Tree Search and Bidirectional Pruning](#link23)
**Authors:** Shuo Yang, Soyeon Caren Han, Yihao Ding, Shuhe Wang, Eduard Hoy

24. [Spectral Defense Against Resource-Targeting Attack in 3D Gaussian Splatting](#link24)
...
26. [Alternating Gradient Flow Utility: A Unified Metric for Structural Pruning and Dynamic Routing in Deep Networks](#link26)
**Authors:** Tianhao Qian, Zhuoxuan Li, Jinde Cao, Xinli Shi, Hanjie Liu, Leszek Rutkowski

27. [Efficient and Interpretable Multi-Agent LLM Routing via Ant Colony Optimization](#link27)
...
28. [OARS: Process-Aware Online Alignment for Generative Real-World Image Super-Resolution](#link28)
...
29. [Hierarchical Dual-Change Collaborative Learning for UAV Scene Change Captioning](#link29)
**Authors:** Fuhai Chen, Pengpeng Huang, Junwen Wu, Hehong Zhang, Shiping Wang, Xiaoguang Ma, Xuri Ge

30. [SDF-Net: Structure-Aware Disentangled Feature Learning for Opticall-SAR Ship Re-identification](#link30)
**Authors:** Furui Chen, Han Wang, Yuhan Sun, Jianing You, Yixuan Lv, Zhuang Zhou, Hong Tan, Shengyang Li

31. [Semantic Invariance in Agentic AI](#link31)
**Authors:** I. de Zarz\`a, J. de Curt\`o, Jordi Cabot, Pietro Manzoni, Carlos T. Calafate

---
## 0. [Multimodal OCR: Parse Anything from Documents](https://arxiv.org/abs/2603.13032) <a id="link0"></a>
**ArXiv ID:** 2603.13032
**Authors:** Handong Zheng, Yumeng Li, Kaile Zhang, Liang Xin, Guangwei Zhao, Hao Liu, Jiayu Chen, Jie Lou, Jiyu Qiu, Qi Fu, Rui Yang, Shuo Jiang, Weijian Luo, Weijie Su, Weijun Zhang, Xingyu Zhu, Yabin Li, Yiwei ma, Yu Chen, Zhaohui Yu, Guang Yang, Colin Zhang, Lei Zhang, Yuliang Liu, Xiang Bai
...
**Comment:** Matches criterion 2 as it introduces a multimodal OCR system that integrates text and graphics parsing, and criterion 5 as it combines image understanding tasks with multimodal supervision.
**Relevance:** 9
**Novelty:** 8

---

## 1. [V-Bridge: Bridging Video Generative Priors to Versatile Few-shot Image Restoration](https://arxiv.org/abs/2603.13089) <a id="link1"></a>
**ArXiv ID:** 2603.13089
**Authors:** Shenghe Zheng, Junpeng Jiang, Wenbo Li
...
**Comment:** Matches criterion 5 as it explores the integration of video generative models with image restoration tasks, combining video understanding and generative modeling.
**Relevance:** 9
**Novelty:** 8

---

## 2. [ESPIRE: A Diagnostic Benchmark for Embodied Spatial Reasoning of Vision-Language Models](https://arxiv.org/abs/2603.13033) <a id="link2"></a>
**ArXiv ID:** 2603.13033
**Authors:** Yanpeng Zhao, Wentao Ding, Hongtao Li, Baoxiong Jia, Zilong Zheng
...
**Comment:** Matches criteria 1 and 3 as it introduces a new benchmark for embodied spatial reasoning in vision-language models.
**Relevance:** 9
**Novelty:** 8

---

## 3. [PVI: Plug-in Visual Injection for Vision-Language-Action Models](https://arxiv.org/abs/2603.12772) <a id="link3"></a>
**ArXiv ID:** 2603.12772
**Authors:** Zezhou Zhang, Songxin Zhang, Xiao Xiong, Junjie Zhang, Zejian Xie, Jingyi Xi, Zunyao Mao, Zan Mao, Zhixin Mai, Zhuoyang Song, Jiaxing Zhang
...
**Comment:** Matches criteria 3 and 5 as it introduces a novel method for vision-language-action models and explores integration of video features with large language models.
**Relevance:** 9
**Novelty:** 8

---

## 4. [SPARROW: Learning Spatial Precision and Temporal Referential Consistency in Pixel-Grounded Video MLLMs](https://arxiv.org/abs/2603.12382) <a id="link4"></a>
**ArXiv ID:** 2603.12382
**Authors:** Mohamad Alansari, Naufal Suryanto, Divya Velayudhan, Sajid Javed, Naoufel Werghi, Muzammal Naseer
...
**Comment:** Matches criterion 2 and 6 as it focuses on pixel-grounded video MLLMs and improves spatial precision and temporal consistency in video understanding.
**Relevance:** 9
**Novelty:** 7

---

## 5. [Towards Spatio-Temporal World Scene Graph Generation from Monocular Videos](https://arxiv.org/abs/2603.13185) <a id="link5"></a>
**ArXiv ID:** 2603.13185
**Authors:** Rohith Peddi, Saurabh, Shravan Shanmugam, Likhitha Pallapothula, Yu Xiang, Parag Singla, Vibhav Gogate
...
**Comment:** Matches criterion 6 as it introduces a new dataset and methods for spatio-temporal scene graph generation from videos, advancing video understanding.
**Relevance:** 9
**Novelty:** 7

---

## 6. [Cheers: Decoupling Patch Details from Semantic Representations Enables Unified Multimodal Comprehension and Generation](https://arxiv.org/abs/2603.12793) <a id="link6"></a>
**ArXiv ID:** 2603.12793
**Authors:** Yichen Zhang, Da Peng, Zonghao Guo, Zijian Zhang, Xuesong Yang, Tong Sun, Shichu Sun, Yidan Zhang, Yanghao Li, Haiyan Zhao, Wang Xu, Qi Shi, Yangang Sun, Chi Chen, Shuo Wang, Yukun Yan, Xu Han, Qiang Ma, Wei Ke, Liang Wang, Zhiyuan Liu, Maosong Sun
...
**Comment:** Matches criterion 2 as it introduces a unified multimodal model (Cheers) for visual comprehension and generation, relevant to multimodal large language models.
**Relevance:** 9
**Novelty:** 7

---

## 7. [Test-Time Attention Purification for Backdoored Large Vision Language Models](https://arxiv.org/abs/2603.12989) <a id="link7"></a>
**ArXiv ID:** 2603.12989
**Authors:** Zhifang Zhang, Bojun Yang, Shuo He, Weitong Chen, Wei Emma Zhang, Olaf Maennel, Lei Feng, Miao Xu
...
**Comment:** Matches criterion 2 as it explores vulnerabilities and defenses in large vision-language models (LVLMs), focusing on cross-modal attention mechanisms.
**Relevance:** 8
**Novelty:** 7

---

## 8. [VFM-Recon: Unlocking Cross-Domain Scene-Level Neural Reconstruction with Scale-Aligned Foundation Priors](https://arxiv.org/abs/2603.12657) <a id="link8"></a>
**ArXiv ID:** 2603.12657
**Authors:** Yuhang Ming, Tingkang Xi, Xingrui Yang, Lixin Yang, Yong Peng, Cewu Lu, Wanzeng Kong
...
**Comment:** Matches criterion 4 as it bridges vision foundation models with neural volumetric reconstruction, focusing on cross-domain scene-level reconstruction.
**Relevance:** 8
**Novelty:** 7

---

## 9. [MemRoPE: Training-Free Infinite Video Generation via Evolving Memory Tokens](https://arxiv.org/abs/2603.12513) <a id="link9"></a>
**ArXiv ID:** 2603.12513
**Authors:** Youngrae Kim, Qixin Hu, C. -C. Jay Kuo, Peter A. Beerel
...
**Comment:** Matches criterion 6 as it introduces a novel framework for infinite video generation with improved temporal coherence and fidelity.
**Relevance:** 8
**Novelty:** 7

---

## 10. [Thinking in Dynamics: How Multimodal Large Language Models Perceive, Track, and Reason Dynamics in Physical 4D World](https://arxiv.org/abs/2603.12746) <a id="link10"></a>
**ArXiv ID:** 2603.12746
**Authors:** Yuzhi Huang, Kairun Wen, Rongxin Gao, Dongxuan Liu, Yibin Lou, Jie Wu, Jing Xu, Jian Zhang, Zheng Yang, Yunlong Lin, Chenxin Li, Panwang Pan, Junbin Lu, Jingyan Jiang, Xinghao Ding, Yue Huang, Zhi Wang
...
**Comment:** Matches criterion 6 as it introduces a benchmark (Dyn-Bench) for video understanding and spatio-temporal reasoning in dynamic scenes.
**Relevance:** 8
**Novelty:** 7

---

## 11. [Composing Driving Worlds through Disentangled Control for Adversarial Scenario Generation](https://arxiv.org/abs/2603.12864) <a id="link11"></a>
**ArXiv ID:** 2603.12864
**Authors:** Yifan Zhan, Zhengqing Chen, Qingjie Wang, Zhuo He, Muyao Niu, Xiaoyang Guo, Wei Yin, Weiqiang Ren, Qian Zhang, Yinqiang Zheng
...
**Comment:** Matches criterion 3 as it introduces a novel simulator (CompoSIA) for generating adversarial driving scenarios, which is relevant to embodied/robotic AI benchmarks.
**Relevance:** 8
**Novelty:** 7

---

## 12. [Finite Difference Flow Optimization for RL Post-Training of Text-to-Image Models](https://arxiv.org/abs/2603.12893) <a id="link12"></a>
**ArXiv ID:** 2603.12893
**Authors:** David McAllister, Miika Aittala, Tero Karras, Janne Hellsten, Angjoo Kanazawa, Timo Aila, Samuli Laine
...
**Comment:** Matches criteria 5 as it explores reinforcement learning for text-to-image models, integrating image generation tasks with language models.
**Relevance:** 8
**Novelty:** 7

---

## 13. [SAW: Toward a Surgical Action World Model via Controllable and Scalable Video Generation](https://arxiv.org/abs/2603.13024) <a id="link13"></a>
**ArXiv ID:** 2603.13024
**Authors:** Sampath Rapuri, Lalithkumar Seenivasan, Dominik Schneider, Roger Soberanis-Mukul, Yufan He, Hao Ding, Jiru Xu, Chenhao Yu, Chenyan Jing, Pengfei Guo, Daguang Xu, Mathias Unberath
...
**Comment:** Matches criteria 6 as it focuses on video understanding for surgical action modeling and introduces a novel video generation approach.
**Relevance:** 8
**Novelty:** 7

---

## 14. [Generalized Recognition of Basic Surgical Actions Enables Skill Assessment and Vision-Language-Model-based Surgical Planning](https://arxiv.org/abs/2603.12787) <a id="link14"></a>
**ArXiv ID:** 2603.12787
**Authors:** Mengya Xu, Daiyun Shen, Jie Zhang, Hon Chi Yip, Yujia Gao, Cheng Chen, Dillan Imans, Yonghao Long, Yiru Ye, Yixiao Liu, Rongyun Mai, Kai Chen, Hongliang Ren, Yutong Ban, Guangsuo Wang, Francis Wong, Chi-Fai Ng, Kee Yuan Ngiam, Russell H. Taylor, Daguang Xu, Yueming Jin, Qi Dou
...
**Comment:** Matches criteria 2 and 5 as it explores vision-language models for surgical planning and integrates image understanding with large language models.
**Relevance:** 8
**Novelty:** 7

---

## 15. [SAP: Segment Any 4K Panorama](https://arxiv.org/abs/2603.12759) <a id="link15"></a>
**ArXiv ID:** 2603.12759
**Authors:** Lutao Jiang, Zidong Cao, Weikai Chen, Xu Zheng, Yuanhuiyi Lyu, Zhenyang Li, Zeyu HU, Yingda Yin, Keyang Luo, Runze Zhang, Kai Yan, Shengju Qian, Haidi Fan, Yifan Peng, Xin Wang, Hui Xiong, Ying-Cong Chen
...
**Comment:** Matches criterion 4 as it introduces a foundation model for panoramic instance segmentation, focusing on vision foundation models.
**Relevance:** 8
**Novelty:** 6

---

## 16. [A Closed-Form Solution for Debiasing Vision-Language Models with Utility Guarantees Across Modalities and Tasks](https://arxiv.org/abs/2603.12998) <a id="link16"></a>
**ArXiv ID:** 2603.12998
**Authors:** Tangzheng Lian, Guanyu Hu, Yijing Ren, Dimitrios Kollias, Oya Celiktutan
...
**Comment:** Matches criterion 2 as it focuses on debiasing Vision-Language Models (VLLMs) with a novel closed-form solution.
**Relevance:** 8
**Novelty:** 6

---

## 17. [AVION: Aerial Vision-Language Instruction from Offline Teacher to Prompt-Tuned Network](https://arxiv.org/abs/2603.12659) <a id="link17"></a>
**ArXiv ID:** 2603.12659
**Authors:** Yu Hu, Jianyang Gu, Hao Liu, Yue Cao, Jozsef Hamari, Zheng Liu, Mohsen Zardadi
...
**Comment:** Matches criterion 2 as it adapts vision-language models to remote sensing imagery, focusing on multimodal learning.
**Relevance:** 7
**Novelty:** 6

---

## 18. [MRGeo: Robust Cross-View Geo-Localization of Corrupted Images via Spatial and Channel Feature Enhancement](https://arxiv.org/abs/2603.12587) <a id="link18"></a>
**ArXiv ID:** 2603.12587
**Authors:** Le Wu, Lv Bo, Songsong Ouyang, Yingying Zhu
...
**Comment:** Matches criterion 1 as it focuses on spatial reasoning and robustness in cross-view geo-localization, which is relevant to spatial intelligence.
**Relevance:** 7
**Novelty:** 6

---

## 19. [FedBPrompt: Federated Domain Generalization Person Re-Identification via Body Distribution Aware Visual Prompts](https://arxiv.org/abs/2603.12912) <a id="link19"></a>
**ArXiv ID:** 2603.12912
**Authors:** Xin Xu, Weilong Li, Wei Liu, Wenke Huang, Zhixi Yu, Bin Yang, Xiaoying Liao, Kui Jiang
...
**Comment:** Matches criterion 3 as it introduces a novel method (FedBPrompt) for federated person re-identification, which is relevant to embodied/robotic AI.
**Relevance:** 7
**Novelty:** 6

---

## 20. [InterEdit: Navigating Text-Guided Multi-Human 3D Motion Editing](https://arxiv.org/abs/2603.13082) <a id="link20"></a>
**ArXiv ID:** 2603.13082
**Authors:** Yebin Yang, Di Wen, Lei Qi, Weitong Kong, Junwei Zheng, Ruiping Liu, Yufan Chen, Chengzhi Wu, Kailun Yang, Yuqian Fu, Danda Pani Paudel, Luc Van Gool, Kunyu Peng
...
**Comment:** Matches criteria 6 as it focuses on video-based tasks, specifically multi-human 3D motion editing, and introduces a novel dataset and benchmark.
**Relevance:** 7
**Novelty:** 6

---

## 21. [Mitigating Memorization in Text-to-Image Diffusion via Region-Aware Prompt Augmentation and Multimodal Copy Detection](https://arxiv.org/abs/2603.13070) <a id="link21"></a>
**ArXiv ID:** 2603.13070
**Authors:** Yunzhuo Chen, Jordan Vice, Naveed Akhtar, Nur Al Hasan Haldar, Ajmal Mian
...
**Comment:** Matches criterion 5 as it discusses techniques combining image understanding tasks (text-to-image diffusion) with multimodal detection strategies.
**Relevance:** 7
**Novelty:** 5

---

## 22. [NOIR: Neural Operator mapping for Implicit Representations](https://arxiv.org/abs/2603.13118) <a id="link22"></a>
**ArXiv ID:** 2603.13118
**Authors:** Sidaty El Hadramy, Nazim Haouchine, Michael Wehrli, Philippe C. Cattin
...
**Comment:** Does not closely match any specific criterion but is generally relevant to medical imaging and implicit representations.
**Relevance:** 3
**Novelty:** 6

---

## 23. [ToolTree: Efficient LLM Agent Tool Planning via Dual-Feedback Monte Carlo Tree Search and Bidirectional Pruning](https://arxiv.org/abs/2603.12740) <a id="link23"></a>
**ArXiv ID:** 2603.12740
**Authors:** Shuo Yang, Soyeon Caren Han, Yihao Ding, Shuhe Wang, Eduard Hoy
...
**Comment:** Does not closely match any specific criterion but is generally relevant to AI and tool planning.
**Relevance:** 3
**Novelty:** 5

---

## 24. [Spectral Defense Against Resource-Targeting Attack in 3D Gaussian Splatting](https://arxiv.org/abs/2603.12796) <a id="link24"></a>
**ArXiv ID:** 2603.12796
**Authors:** Yang Chen, Yi Yu, Jiaming He, Yueqi Duan, Zheng Zhu, Yap-Peng Tan
...
**Comment:** Does not closely match any specific criterion but is generally relevant to 3D vision and robustness in rendering.
**Relevance:** 3
**Novelty:** 5
...
**Comment:** Does not closely match any specific criterion but is generally relevant to vision-language grounding and machine learning.
**Relevance:** 3
**Novelty:** 5

---

## 26. [Alternating Gradient Flow Utility: A Unified Metric for Structural Pruning and Dynamic Routing in Deep Networks](https://arxiv.org/abs/2603.12354) <a id="link26"></a>
**ArXiv ID:** 2603.12354
**Authors:** Tianhao Qian, Zhuoxuan Li, Jinde Cao, Xinli Shi, Hanjie Liu, Leszek Rutkowski
...
## 27. [Efficient and Interpretable Multi-Agent LLM Routing via Ant Colony Optimization](https://arxiv.org/abs/2603.12933) <a id="link27"></a>
**ArXiv ID:** 2603.12933
**Authors:** Xudong Wang, Chaoning Zhang, Jiaquan Zhang, Chenghao Li, Qigan Sun, Sung-Ho Bae, Peng Wang, Ning Xie, Jie Zou, Yang Yang, Hengtao Shen
...
**Comment:** Does not match any specific criteria but is relevant to the general interest area of multi-agent systems and optimization.
**Relevance:** 3
**Novelty:** 5

---

## 28. [OARS: Process-Aware Online Alignment for Generative Real-World Image Super-Resolution](https://arxiv.org/abs/2603.12811) <a id="link28"></a>
**ArXiv ID:** 2603.12811
**Authors:** Shijie Zhao, Xuanyu Zhang, Bin Chen, Weiqi Li, Qunliang Xing, Kexin Zhang, Yan Wang, Junlin Li, Li Zhang, Jian Zhang, Tianfan Xue
...
## 29. [Hierarchical Dual-Change Collaborative Learning for UAV Scene Change Captioning](https://arxiv.org/abs/2603.12832) <a id="link29"></a>
**ArXiv ID:** 2603.12832
**Authors:** Fuhai Chen, Pengpeng Huang, Junwen Wu, Hehong Zhang, Shiping Wang, Xiaoguang Ma, Xuri Ge
...
## 30. [SDF-Net: Structure-Aware Disentangled Feature Learning for Opticall-SAR Ship Re-identification](https://arxiv.org/abs/2603.12588) <a id="link30"></a>
**ArXiv ID:** 2603.12588
**Authors:** Furui Chen, Han Wang, Yuhan Sun, Jianing You, Yixuan Lv, Zhuang Zhou, Hong Tan, Shengyang Li
...
## 31. [Semantic Invariance in Agentic AI](https://arxiv.org/abs/2603.13173) <a id="link31"></a>
**ArXiv ID:** 2603.13173
**Authors:** I. de Zarz\`a, J. de Curt\`o, Jordi Cabot, Pietro Manzoni, Carlos T. Calafate
...
**Comment:** Does not closely match any specific criterion but is generally relevant to LLM robustness and reasoning.
**Relevance:** 3
**Novelty:** 4
