...
0. [VL-JEPA: Joint Embedding Predictive Architecture for Vision-language](#link0)
...
1. [MMSI-Video-Bench: A Holistic Benchmark for Video-Based Spatial Intelligence](#link1)
...
2. [Latent Chain-of-Thought World Modeling for End-to-End Driving](#link2)
...
3. [OmniView: An All-Seeing Diffusion Model for 3D and 4D View Synthesis](#link3)
...
5. [FoundationMotion: Auto-Labeling and Reasoning about Spatial Movement in Videos](#link5)
...
6. [NaviHydra: Controllable Navigation-guided End-to-end Autonomous Driving with Hydra-distillation](#link6)
**Authors:** Hanfeng Wu, Marlon Steiner, Michael Schmidt, Alvaro Marcos-Ramiro, Christoph Stiller

7. [User-Feedback-Driven Continual Adaptation for Vision-and-Language Navigation](#link7)
**Authors:** Yongqiang Yu, Xuhui Li, Hazza Mahmood, Jinxing Zhou, Haodong Hong, Longtao Jiang, Zhiqiang Xu, Qi Wu, Xiaojun Chang

8. [Omni-Attribute: Open-vocabulary Attribute Encoder for Visual Concept Personalization](#link8)
...
9. [StereoSpace: Depth-Free Synthesis of Stereo Geometry via End-to-End Diffusion in a Canonical Space](#link9)
**Authors:** Tjark Behrens, Anton Obukhov, Bingxin Ke, Fabio Tosi, Matteo Poggi, Konrad Schindler

10. [AlcheMinT: Fine-grained Temporal Control for Multi-Reference Consistent Video Generation](#link10)
**Authors:** Sharath Girish, Viacheslav Ivanov, Tsai-Shien Chen, Hao Chen, Aliaksandr Siarohin, Sergey Tulyakov

11. [WorldLens: Full-Spectrum Evaluations of Driving World Models in Real World](#link11)
...
12. [SWiT-4D: Sliding-Window Transformer for Lossless and Parameter-Free Temporal 4D Generation](#link12)
...
13. [SceneMaker: Open-set 3D Scene Generation with Decoupled De-occlusion and Pose Estimation Model](#link13)
**Authors:** Yukai Shi, Weiyu Li, Zihao Wang, Hongyang Li, Xingyu Chen, Ping Tan, Lei Zhang

14. [Towards Efficient and Effective Multi-Camera Encoding for End-to-End Driving](#link14)
**Authors:** Jiawei Yang, Ziyu Chen, Yurong You, Yan Wang, Yiming Li, Yuxiao Chen, Boyi Li, Boris Ivanovic, Marco Pavone, Yue Wang

15. [Blink: Dynamic Visual Token Resolution for Enhanced Multimodal Understanding](#link15)
...
16. [EchoingPixels: Cross-Modal Adaptive Token Reduction for Efficient Audio-Visual LLMs](#link16)
**Authors:** Chao Gong, Depeng Wang, Zhipeng Wei, Ya Guo, Huijia Zhu, Jingjing Chen

17. [Are We Ready for RL in Text-to-3D Generation? A Progressive Investigation](#link17)
...
18. [HAROOD: A Benchmark for Out-of-distribution Generalization in Sensor-based Human Activity Recognition](#link18)
**Authors:** Wang Lu, Yao Zhu, Jindong Wang

19. [GDKVM: Echocardiography Video Segmentation via Spatiotemporal Key-Value Memory with Gated Delta Rule](#link19)
**Authors:** Rui Wang, Yimu Sun, Jingxing Guo, Huisi Wu, Jing Qin

20. [Hierarchical Instance Tracking to Balance Privacy Preservation with Accessible Information](#link20)
...
21. [From Macro to Micro: Benchmarking Microscopic Spatial Intelligence on Molecules via Vision-Language Models](#link21)
...
22. [MoCapAnything: Unified 3D Motion Capture for Arbitrary Skeletons from Monocular Videos](#link22)
...
23. [Sample-wise Adaptive Weighting for Transfer Consistency in Adversarial Distillation](#link23)
**Authors:** Hongsin Lee, Hye Won Chung

24. [CheXmask-U: Quantifying uncertainty in landmark-based anatomical segmentation for X-ray images](#link24)
**Authors:** Matias Cosarinsky, Nicolas Gaggion, Rodrigo Echeveste, Enzo Ferrante

25. [GaussianHeadTalk: Wobble-Free 3D Talking Heads with Audio Driven Gaussian Splatting](#link25)
**Authors:** Madhav Agarwal, Mingtian Zhang, Laura Sevilla-Lara, Steven McDonagh

26. [MetaVoxel: Joint Diffusion Modeling of Imaging and Clinical Metadata](#link26)
...
27. [TraceFlow: Dynamic 3D Reconstruction of Specular Scenes Driven by Ray Tracing](#link27)
**Authors:** Jiachen Tao, Junyi Wu, Haoxuan Wang, Zongxin Yang, Dawen Cai, Yan Yan

28. [Neuromorphic Eye Tracking for Low-Latency Pupil Detection](#link28)
**Authors:** Paul Hueber, Luca Peres, Florian Pitters, Alejandro Gloriani, Oliver Rhodes

29. [Reverse Thinking Enhances Missing Information Detection in Large Language Models](#link29)
**Authors:** Yuxin Liu, Chaojie Gu, Yihang Zhang, Bin Qian, Shibo He

30. [Achieving Olympia-Level Geometry Large Language Model Agent via Complexity Boosting Reinforcement Learning](#link30)
...
31. [CP-Env: Evaluating Large Language Models on Clinical Pathways in a Controllable Hospital Environment](#link31)
**Authors:** Yakun Zhu, Zhongzhen Huang, Qianhan Feng, Linjie Mu, Yannian Gu, Shaoting Zhang, Qi Dou, Xiaofan Zhang

32. [Adaptive Dual-Weighted Gravitational Point Cloud Denoising Method](#link32)
**Authors:** Ge Zhang, Chunyang Wang, Bo Xiao, Xuelian Liu, Bin Liu

33. [TriDF: Evaluating Perception, Detection, and Hallucination for Interpretable DeepFake Detection](#link33)
...
---
## 0. [VL-JEPA: Joint Embedding Predictive Architecture for Vision-language](https://arxiv.org/abs/2512.10942) <a id="link0"></a>
**ArXiv ID:** 2512.10942
**Authors:** Delong Chen, Mustafa Shukor, Theo Moutakanni, Willy Chung, Jade Yu, Tejaswi Kasarla, Allen Bolourchi, Yann LeCun, Pascale Fung
...
## 1. [MMSI-Video-Bench: A Holistic Benchmark for Video-Based Spatial Intelligence](https://arxiv.org/abs/2512.10863) <a id="link1"></a>
**ArXiv ID:** 2512.10863
**Authors:** Jingli Lin, Runsen Xu, Shaohao Zhu, Sihan Yang, Peizhou Cao, Yunlong Ran, Miao Hu, Chenming Zhu, Yiman Xie, Yilin Long, Wenbo Hu, Dahua Lin, Tai Wang, Jiangmiao Pang
...
## 2. [Latent Chain-of-Thought World Modeling for End-to-End Driving](https://arxiv.org/abs/2512.10226) <a id="link2"></a>
**ArXiv ID:** 2512.10226
**Authors:** Shuhan Tan, Kashyap Chitta, Yuxiao Chen, Ran Tian, Yurong You, Yan Wang, Wenjie Luo, Yulong Cao, Philipp Krahenbuhl, Marco Pavone, Boris Ivanovic
...
## 3. [OmniView: An All-Seeing Diffusion Model for 3D and 4D View Synthesis](https://arxiv.org/abs/2512.10940) <a id="link3"></a>
**ArXiv ID:** 2512.10940
**Authors:** Xiang Fan, Sharath Girish, Vivek Ramanujan, Chaoyang Wang, Ashkan Mirzaei, Petr Sushko, Aliaksandr Siarohin, Sergey Tulyakov, Ranjay Krishna
...
## 5. [FoundationMotion: Auto-Labeling and Reasoning about Spatial Movement in Videos](https://arxiv.org/abs/2512.10927) <a id="link5"></a>
**ArXiv ID:** 2512.10927
**Authors:** Yulu Gan, Ligeng Zhu, Dandan Shan, Baifeng Shi, Hongxu Yin, Boris Ivanovic, Song Han, Trevor Darrell, Jitendra Malik, Marco Pavone, Boyi Li
...
## 6. [NaviHydra: Controllable Navigation-guided End-to-end Autonomous Driving with Hydra-distillation](https://arxiv.org/abs/2512.10660) <a id="link6"></a>
**ArXiv ID:** 2512.10660
**Authors:** Hanfeng Wu, Marlon Steiner, Michael Schmidt, Alvaro Marcos-Ramiro, Christoph Stiller
...
## 7. [User-Feedback-Driven Continual Adaptation for Vision-and-Language Navigation](https://arxiv.org/abs/2512.10322) <a id="link7"></a>
**ArXiv ID:** 2512.10322
**Authors:** Yongqiang Yu, Xuhui Li, Hazza Mahmood, Jinxing Zhou, Haodong Hong, Longtao Jiang, Zhiqiang Xu, Qi Wu, Xiaojun Chang
...
## 8. [Omni-Attribute: Open-vocabulary Attribute Encoder for Visual Concept Personalization](https://arxiv.org/abs/2512.10955) <a id="link8"></a>
**ArXiv ID:** 2512.10955
**Authors:** Tsai-Shien Chen, Aliaksandr Siarohin, Guocheng Gordon Qian, Kuan-Chieh Jackson Wang, Egor Nemchinov, Moayed Haji-Ali, Riza Alp Guler, Willi Menapace, Ivan Skorokhodov, Anil Kag, Jun-Yan Zhu, Sergey Tulyakov
...
## 9. [StereoSpace: Depth-Free Synthesis of Stereo Geometry via End-to-End Diffusion in a Canonical Space](https://arxiv.org/abs/2512.10959) <a id="link9"></a>
**ArXiv ID:** 2512.10959
**Authors:** Tjark Behrens, Anton Obukhov, Bingxin Ke, Fabio Tosi, Matteo Poggi, Konrad Schindler
...
## 10. [AlcheMinT: Fine-grained Temporal Control for Multi-Reference Consistent Video Generation](https://arxiv.org/abs/2512.10943) <a id="link10"></a>
**ArXiv ID:** 2512.10943
**Authors:** Sharath Girish, Viacheslav Ivanov, Tsai-Shien Chen, Hao Chen, Aliaksandr Siarohin, Sergey Tulyakov
...
## 11. [WorldLens: Full-Spectrum Evaluations of Driving World Models in Real World](https://arxiv.org/abs/2512.10958) <a id="link11"></a>
**ArXiv ID:** 2512.10958
**Authors:** Ao Liang, Lingdong Kong, Tianyi Yan, Hongsi Liu, Wesley Yang, Ziqi Huang, Wei Yin, Jialong Zuo, Yixuan Hu, Dekai Zhu, Dongyue Lu, Youquan Liu, Guangfeng Jiang, Linfeng Li, Xiangtai Li, Long Zhuo, Lai Xing Ng, Benoit R. Cottereau, Changxin Gao, Liang Pan, Wei Tsang Ooi, Ziwei Liu
...
## 12. [SWiT-4D: Sliding-Window Transformer for Lossless and Parameter-Free Temporal 4D Generation](https://arxiv.org/abs/2512.10860) <a id="link12"></a>
**ArXiv ID:** 2512.10860
**Authors:** Kehong Gong, Zhengyu Wen, Mingxi Xu, Weixia He, Qi Wang, Ning Zhang, Zhengyu Li, Chenbin Li, Dongze Lian, Wei Zhao, Xiaoyu He, Mingyuan Zhang
...
## 13. [SceneMaker: Open-set 3D Scene Generation with Decoupled De-occlusion and Pose Estimation Model](https://arxiv.org/abs/2512.10957) <a id="link13"></a>
**ArXiv ID:** 2512.10957
**Authors:** Yukai Shi, Weiyu Li, Zihao Wang, Hongyang Li, Xingyu Chen, Ping Tan, Lei Zhang
...
## 14. [Towards Efficient and Effective Multi-Camera Encoding for End-to-End Driving](https://arxiv.org/abs/2512.10947) <a id="link14"></a>
**ArXiv ID:** 2512.10947
**Authors:** Jiawei Yang, Ziyu Chen, Yurong You, Yan Wang, Yiming Li, Yuxiao Chen, Boyi Li, Boris Ivanovic, Marco Pavone, Yue Wang
...
## 15. [Blink: Dynamic Visual Token Resolution for Enhanced Multimodal Understanding](https://arxiv.org/abs/2512.10548) <a id="link15"></a>
**ArXiv ID:** 2512.10548
**Authors:** Yuchen Feng, Zhenyu Zhang, Naibin Gu, Yilong Chen, Peng Fu, Zheng Lin, Shuohuan Wang, Yu Sun, Hua Wu, Weiping Wang, Haifeng Wang
...
## 16. [EchoingPixels: Cross-Modal Adaptive Token Reduction for Efficient Audio-Visual LLMs](https://arxiv.org/abs/2512.10324) <a id="link16"></a>
**ArXiv ID:** 2512.10324
**Authors:** Chao Gong, Depeng Wang, Zhipeng Wei, Ya Guo, Huijia Zhu, Jingjing Chen
...
## 17. [Are We Ready for RL in Text-to-3D Generation? A Progressive Investigation](https://arxiv.org/abs/2512.10949) <a id="link17"></a>
**ArXiv ID:** 2512.10949
**Authors:** Yiwen Tang, Zoey Guo, Kaixin Zhu, Ray Zhang, Qizhi Chen, Dongzhi Jiang, Junli Liu, Bohan Zeng, Haoming Song, Delin Qu, Tianyi Bai, Dan Xu, Wentao Zhang, Bin Zhao
...
## 18. [HAROOD: A Benchmark for Out-of-distribution Generalization in Sensor-based Human Activity Recognition](https://arxiv.org/abs/2512.10807) <a id="link18"></a>
**ArXiv ID:** 2512.10807
**Authors:** Wang Lu, Yao Zhu, Jindong Wang
...
## 19. [GDKVM: Echocardiography Video Segmentation via Spatiotemporal Key-Value Memory with Gated Delta Rule](https://arxiv.org/abs/2512.10252) <a id="link19"></a>
**ArXiv ID:** 2512.10252
**Authors:** Rui Wang, Yimu Sun, Jingxing Guo, Huisi Wu, Jing Qin
...
## 20. [Hierarchical Instance Tracking to Balance Privacy Preservation with Accessible Information](https://arxiv.org/abs/2512.10102) <a id="link20"></a>
**ArXiv ID:** 2512.10102
**Authors:** Neelima Prasad, Jarek Reynolds, Neel Karsanbhai, Tanusree Sharma, Lotus Zhang, Abigale Stangl, Yang Wang, Leah Findlater, Danna Gurari
...
## 21. [From Macro to Micro: Benchmarking Microscopic Spatial Intelligence on Molecules via Vision-Language Models](https://arxiv.org/abs/2512.10867) <a id="link21"></a>
**ArXiv ID:** 2512.10867
**Authors:** Zongzhao Li, Xiangzhe Kong, Jiahui Su, Zongyang Ma, Mingze Li, Songyou Li, Yuelin Zhang, Yu Rong, Tingyang Xu, Deli Zhao, Wenbing Huang
...
## 22. [MoCapAnything: Unified 3D Motion Capture for Arbitrary Skeletons from Monocular Videos](https://arxiv.org/abs/2512.10881) <a id="link22"></a>
**ArXiv ID:** 2512.10881
**Authors:** Kehong Gong, Zhengyu Wen, Weixia He, Mingxi Xu, Qi Wang, Ning Zhang, Zhengyu Li, Dongze Lian, Wei Zhao, Xiaoyu He, Mingyuan Zhang
...
## 23. [Sample-wise Adaptive Weighting for Transfer Consistency in Adversarial Distillation](https://arxiv.org/abs/2512.10275) <a id="link23"></a>
**ArXiv ID:** 2512.10275
**Authors:** Hongsin Lee, Hye Won Chung
...
## 24. [CheXmask-U: Quantifying uncertainty in landmark-based anatomical segmentation for X-ray images](https://arxiv.org/abs/2512.10715) <a id="link24"></a>
**ArXiv ID:** 2512.10715
**Authors:** Matias Cosarinsky, Nicolas Gaggion, Rodrigo Echeveste, Enzo Ferrante
...
## 25. [GaussianHeadTalk: Wobble-Free 3D Talking Heads with Audio Driven Gaussian Splatting](https://arxiv.org/abs/2512.10939) <a id="link25"></a>
**ArXiv ID:** 2512.10939
**Authors:** Madhav Agarwal, Mingtian Zhang, Laura Sevilla-Lara, Steven McDonagh
...
## 26. [MetaVoxel: Joint Diffusion Modeling of Imaging and Clinical Metadata](https://arxiv.org/abs/2512.10041) <a id="link26"></a>
**ArXiv ID:** 2512.10041
**Authors:** Yihao Liu, Chenyu Gao, Lianrui Zuo, Michael E. Kim, Brian D. Boyd, Lisa L. Barnes, Walter A. Kukull, Lori L. Beason-Held, Susan M. Resnick, Timothy J. Hohman, Warren D. Taylor, Bennett A. Landman
...
## 27. [TraceFlow: Dynamic 3D Reconstruction of Specular Scenes Driven by Ray Tracing](https://arxiv.org/abs/2512.10095) <a id="link27"></a>
**ArXiv ID:** 2512.10095
**Authors:** Jiachen Tao, Junyi Wu, Haoxuan Wang, Zongxin Yang, Dawen Cai, Yan Yan
...
## 28. [Neuromorphic Eye Tracking for Low-Latency Pupil Detection](https://arxiv.org/abs/2512.09969) <a id="link28"></a>
**ArXiv ID:** 2512.09969
**Authors:** Paul Hueber, Luca Peres, Florian Pitters, Alejandro Gloriani, Oliver Rhodes
...
## 29. [Reverse Thinking Enhances Missing Information Detection in Large Language Models](https://arxiv.org/abs/2512.10273) <a id="link29"></a>
**ArXiv ID:** 2512.10273
**Authors:** Yuxin Liu, Chaojie Gu, Yihang Zhang, Bin Qian, Shibo He
...
## 30. [Achieving Olympia-Level Geometry Large Language Model Agent via Complexity Boosting Reinforcement Learning](https://arxiv.org/abs/2512.10534) <a id="link30"></a>
**ArXiv ID:** 2512.10534
**Authors:** Haiteng Zhao, Junhao Shen, Yiming Zhang, Songyang Gao, Kuikun Liu, Tianyou Ma, Fan Zheng, Dahua Lin, Wenwei Zhang, Kai Chen
...
## 31. [CP-Env: Evaluating Large Language Models on Clinical Pathways in a Controllable Hospital Environment](https://arxiv.org/abs/2512.10206) <a id="link31"></a>
**ArXiv ID:** 2512.10206
**Authors:** Yakun Zhu, Zhongzhen Huang, Qianhan Feng, Linjie Mu, Yannian Gu, Shaoting Zhang, Qi Dou, Xiaofan Zhang
...
## 32. [Adaptive Dual-Weighted Gravitational Point Cloud Denoising Method](https://arxiv.org/abs/2512.10386) <a id="link32"></a>
**ArXiv ID:** 2512.10386
**Authors:** Ge Zhang, Chunyang Wang, Bo Xiao, Xuelian Liu, Bin Liu
...
## 33. [TriDF: Evaluating Perception, Detection, and Hallucination for Interpretable DeepFake Detection](https://arxiv.org/abs/2512.10652) <a id="link33"></a>
**ArXiv ID:** 2512.10652
**Authors:** Jian-Yu Jiang-Lin, Kang-Yang Huang, Ling Zou, Ling Lo, Sheng-Ping Yang, Yu-Wen Tseng, Kun-Hsiang Lin, Chia-Ling Chen, Yu-Ting Ta, Yan-Tsung Wang, Po-Ching Chen, Hongxia Xie, Hong-Han Shuai, Wen-Huang Cheng
