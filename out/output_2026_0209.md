...
0. [SPARC: Separating Perception And Reasoning Circuits for Test-time Scaling of VLMs](#link0)
...
2. [Taming SAM3 in the Wild: A Concept Bank for Open-Vocabulary Segmentation](#link2)
**Authors:** Gensheng Pei, Xiruo Jiang, Yazhou Yao, Xiangbo Shu, Fumin Shen, Byeungwoo Jeon

3. [ChatUMM: Robust Context Tracking for Conversational Interleaved Generation](#link3)
...
4. [Driving with DINO: Vision Foundation Features as a Unified Bridge for Sim-to-Real Generation in Autonomous Driving](#link4)
...
5. [SPDA-SAM: A Self-prompted Depth-Aware Segment Anything Model for Instance Segmentation](#link5)
**Authors:** Yihan Shang, Wei Wang, Chao Huang, Xinghui Dong

6. [CineScene: Implicit 3D as Effective Scene Representation for Cinematic Video Generation](#link6)
...
7. [Rethinking Multi-Condition DiTs: Eliminating Redundant Attention via Position-Alignment and Keyword-Scoping](#link7)
**Authors:** Chao Zhou, Tianyi Wei, Yiling Chen, Wenbo Zhou, Nenghai Yu

8. [MeDocVL: A Visual Language Model for Medical Document Understanding and Parsing](#link8)
...
9. [Uncertainty-Aware 4D Gaussian Splatting for Monocular Occluded Human Rendering](#link9)
**Authors:** Weiquan Wang, Feifei Shao, Lin Li, Zhen Wang, Jun Xiao, Long Chen

10. [LAB-Det: Language as a Domain-Invariant Bridge for Training-Free One-Shot Domain Generalization in Object Detection](#link10)
**Authors:** Xu Zhang, Zhe Chen, Jing Zhang, Dacheng Tao

11. [AIRS-Bench: a Suite of Tasks for Frontier AI Research Science Agents](#link11)
...
12. [PhenoLIP: Integrating Phenotype Ontology Knowledge into Medical Vision-Language Pretraining](#link12)
**Authors:** Cheng Liang, Chaoyi Wu, Weike Zhao, Ya Zhang, Yanfeng Wang, Weidi Xie

13. [Efficient-LVSM: Faster, Cheaper, and Better Large View Synthesis Model via Decoupled Co-Refinement Attention](#link13)
**Authors:** Xiaosong Jia, Yihang Sun, Junqi You, Songbur Wong, Zichen Zou, Junchi Yan, Zuxuan Wu, Yu-Gang Jiang

14. [AnyThermal: Towards Learning Universal Representations for Thermal Perception](#link14)
...
15. [FlowConsist: Make Your Flow Consistent with Real Trajectory](#link15)
**Authors:** Tianyi Zhang, Chengcheng Liu, Jinwei Chen, Chun-Le Guo, Chongyi Li, Ming-Ming Cheng, Bo Li, Peng-Tao Jiang

16. [NECromancer: Breathing Life into Skeletons via BVH Animation](#link16)
...
17. [Difficulty-Estimated Policy Optimization](#link17)
...
19. [Clinical-Prior Guided Multi-Modal Learning with Latent Attention Pooling for Gait-Based Scoliosis Screening](#link19)
**Authors:** Dong Chen, Zizhuang Wei, Jialei Xu, Xinyang Sun, Zonglin He, Meiru An, Huili Peng, Yong Hu, Kenneth MC Cheung

20. [Forest canopy height estimation from satellite RGB imagery using large-scale airborne LiDAR-derived training data and monocular depth estimation](#link20)
**Authors:** Yongkang Lai, Xihan Mu, Tim R. McVicar, Dasheng Fan, Donghui Xie, Shanxin Guo, Wenli Huang, Tianjie Zhao, Guangjian Yan

---
## 0. [SPARC: Separating Perception And Reasoning Circuits for Test-time Scaling of VLMs](https://arxiv.org/abs/2602.06566) <a id="link0"></a>
**ArXiv ID:** 2602.06566
**Authors:** Niccolo Avogaro, Nayanika Debnath, Li Mi, Thomas Frick, Junling Wang, Zexue He, Hang Hua, Konrad Schindler, Mattia Rigotti
...
## 2. [Taming SAM3 in the Wild: A Concept Bank for Open-Vocabulary Segmentation](https://arxiv.org/abs/2602.06333) <a id="link2"></a>
**ArXiv ID:** 2602.06333
**Authors:** Gensheng Pei, Xiruo Jiang, Yazhou Yao, Xiangbo Shu, Fumin Shen, Byeungwoo Jeon
...
## 3. [ChatUMM: Robust Context Tracking for Conversational Interleaved Generation](https://arxiv.org/abs/2602.06442) <a id="link3"></a>
**ArXiv ID:** 2602.06442
**Authors:** Wenxun Dai, Zhiyuan Zhao, Yule Zhong, Yiji Cheng, Jianwei Zhang, Linqing Wang, Shiyi Zhang, Yunlong Lin, Runze He, Fellix Song, Wayne Zhuang, Yong Liu, Haoji Zhang, Yansong Tang, Qinglin Lu, Chunyu Wang
...
## 4. [Driving with DINO: Vision Foundation Features as a Unified Bridge for Sim-to-Real Generation in Autonomous Driving](https://arxiv.org/abs/2602.06159) <a id="link4"></a>
**ArXiv ID:** 2602.06159
**Authors:** Xuyang Chen, Conglang Zhang, Chuanheng Fu, Zihao Yang, Kaixuan Zhou, Yizhi Zhang, Jianan He, Yanfeng Zhang, Mingwei Sun, Zengmao Wang, Zhen Dong, Xiaoxiao Long, Liqiu Meng
...
## 5. [SPDA-SAM: A Self-prompted Depth-Aware Segment Anything Model for Instance Segmentation](https://arxiv.org/abs/2602.06335) <a id="link5"></a>
**ArXiv ID:** 2602.06335
**Authors:** Yihan Shang, Wei Wang, Chao Huang, Xinghui Dong
...
## 6. [CineScene: Implicit 3D as Effective Scene Representation for Cinematic Video Generation](https://arxiv.org/abs/2602.06959) <a id="link6"></a>
**ArXiv ID:** 2602.06959
**Authors:** Kaiyi Huang, Yukun Huang, Yu Li, Jianhong Bai, Xintao Wang, Zinan Lin, Xuefei Ning, Jiwen Yu, Pengfei Wan, Yu Wang, Xihui Liu
...
## 7. [Rethinking Multi-Condition DiTs: Eliminating Redundant Attention via Position-Alignment and Keyword-Scoping](https://arxiv.org/abs/2602.06850) <a id="link7"></a>
**ArXiv ID:** 2602.06850
**Authors:** Chao Zhou, Tianyi Wei, Yiling Chen, Wenbo Zhou, Nenghai Yu
...
## 8. [MeDocVL: A Visual Language Model for Medical Document Understanding and Parsing](https://arxiv.org/abs/2602.06402) <a id="link8"></a>
**ArXiv ID:** 2602.06402
**Authors:** Wenjie Wang, Wei Wu, Ying Liu, Yuan Zhao, Xiaole Lv, Liang Diao, Zengjian Fan, Wenfeng Xie, Ziling Lin, De Shi, Lin Huang, Kaihe Xu, Hong Li
...
## 9. [Uncertainty-Aware 4D Gaussian Splatting for Monocular Occluded Human Rendering](https://arxiv.org/abs/2602.06343) <a id="link9"></a>
**ArXiv ID:** 2602.06343
**Authors:** Weiquan Wang, Feifei Shao, Lin Li, Zhen Wang, Jun Xiao, Long Chen
...
## 10. [LAB-Det: Language as a Domain-Invariant Bridge for Training-Free One-Shot Domain Generalization in Object Detection](https://arxiv.org/abs/2602.06474) <a id="link10"></a>
**ArXiv ID:** 2602.06474
**Authors:** Xu Zhang, Zhe Chen, Jing Zhang, Dacheng Tao
...
## 11. [AIRS-Bench: a Suite of Tasks for Frontier AI Research Science Agents](https://arxiv.org/abs/2602.06855) <a id="link11"></a>
**ArXiv ID:** 2602.06855
**Authors:** Alisia Lupidi, Bhavul Gauri, Thomas Simon Foster, Bassel Al Omari, Despoina Magka, Alberto Pepe, Alexis Audran-Reiss, Muna Aghamelu, Nicolas Baldwin, Lucia Cipolina-Kun, Jean-Christophe Gagnon-Audet, Chee Hau Leow, Sandra Lefdal, Hossam Mossalam, Abhinav Moudgil, Saba Nazir, Emanuel Tewolde, Isabel Urrego, Jordi Armengol Estape, Amar Budhiraja, Gaurav Chaurasia, Abhishek Charnalia, Derek Dunfield, Karen Hambardzumyan, Daniel Izcovich, Martin Josifoski, Ishita Mediratta, Kelvin Niu, Parth Pathak, Michael Shvartsman, Edan Toledo, Anton Protopopov, Roberta Raileanu, Alexander Miller, Tatiana Shavrina, Jakob Foerster, Yoram Bachrach
...
## 12. [PhenoLIP: Integrating Phenotype Ontology Knowledge into Medical Vision-Language Pretraining](https://arxiv.org/abs/2602.06184) <a id="link12"></a>
**ArXiv ID:** 2602.06184
**Authors:** Cheng Liang, Chaoyi Wu, Weike Zhao, Ya Zhang, Yanfeng Wang, Weidi Xie
...
## 13. [Efficient-LVSM: Faster, Cheaper, and Better Large View Synthesis Model via Decoupled Co-Refinement Attention](https://arxiv.org/abs/2602.06478) <a id="link13"></a>
**ArXiv ID:** 2602.06478
**Authors:** Xiaosong Jia, Yihang Sun, Junqi You, Songbur Wong, Zichen Zou, Junchi Yan, Zuxuan Wu, Yu-Gang Jiang
...
## 14. [AnyThermal: Towards Learning Universal Representations for Thermal Perception](https://arxiv.org/abs/2602.06203) <a id="link14"></a>
**ArXiv ID:** 2602.06203
**Authors:** Parv Maheshwari, Jay Karhade, Yogesh Chawla, Isaiah Adu, Florian Heisen, Andrew Porco, Andrew Jong, Yifei Liu, Santosh Pitla, Sebastian Scherer, Wenshan Wang
...
## 15. [FlowConsist: Make Your Flow Consistent with Real Trajectory](https://arxiv.org/abs/2602.06346) <a id="link15"></a>
**ArXiv ID:** 2602.06346
**Authors:** Tianyi Zhang, Chengcheng Liu, Jinwei Chen, Chun-Le Guo, Chongyi Li, Ming-Ming Cheng, Bo Li, Peng-Tao Jiang
...
## 16. [NECromancer: Breathing Life into Skeletons via BVH Animation](https://arxiv.org/abs/2602.06548) <a id="link16"></a>
**ArXiv ID:** 2602.06548
**Authors:** Mingxi Xu, Qi Wang, Zhengyu Wen, Phong Dao Thien, Zhengyu Li, Ning Zhang, Xiaoyu He, Wei Zhao, Kehong Gong, Mingyuan Zhang
...
## 17. [Difficulty-Estimated Policy Optimization](https://arxiv.org/abs/2602.06375) <a id="link17"></a>
**ArXiv ID:** 2602.06375
**Authors:** Yu Zhao, Fan Jiang, Tianle Liu, Bo Zeng, Yu Liu, Longyue Wang, Weihua Luo
...
## 19. [Clinical-Prior Guided Multi-Modal Learning with Latent Attention Pooling for Gait-Based Scoliosis Screening](https://arxiv.org/abs/2602.06743) <a id="link19"></a>
**ArXiv ID:** 2602.06743
**Authors:** Dong Chen, Zizhuang Wei, Jialei Xu, Xinyang Sun, Zonglin He, Meiru An, Huili Peng, Yong Hu, Kenneth MC Cheung
...
## 20. [Forest canopy height estimation from satellite RGB imagery using large-scale airborne LiDAR-derived training data and monocular depth estimation](https://arxiv.org/abs/2602.06503) <a id="link20"></a>
**ArXiv ID:** 2602.06503
**Authors:** Yongkang Lai, Xihan Mu, Tim R. McVicar, Dasheng Fan, Donghui Xie, Shanxin Guo, Wenli Huang, Tianjie Zhao, Guangjian Yan
