...
0. [DualCoT-VLA: Visual-Linguistic Chain of Thought via Parallel Reasoning for Vision-Language-Action Models](#link0)
...
1. [The Universal Normal Embedding](#link1)
**Authors:** Chen Tasker, Roy Betser, Eyal Gofer, Meir Yossef Levi, Guy Gilboa

2. [Speed by Simplicity: A Single-Stream Architecture for Fast Audio-Video Generative Foundation Model](#link2)
...
3. [VGS-Decoding: Visual Grounding Score Guided Decoding for Hallucination Mitigation in Medical VLMs](#link3)
**Authors:** Govinda Kolli, Adinath Madhavrao Dukre, Behzad Bozorgtabar, Dwarikanath Mahapatra, Imran Razzak

4. [FreeArtGS: Articulated Gaussian Splatting Under Free-moving Scenario](#link4)
**Authors:** Hang Dai, Hongwei Fan, Han Zhang, Duojin Wu, Jiyao Zhang, Hao Dong

5. [Learning Progressive Adaptation for Multi-Modal Tracking](#link5)
**Authors:** He Wang, Tianyang Xu, Zhangyong Tang, Xiao-Jun Wu, Josef Kittler

6. [Transparent Fragments Contour Estimation via Visual-Tactile Fusion for Autonomous Reassembly](#link6)
**Authors:** Qihao Lin, Borui Chen, Yuping Zhou, Jianing Wu, Yulan Guo, Weishi Zheng, Chongkun Xia

7. [NCSTR: Node-Centric Decoupled Spatio-Temporal Reasoning for Video-based Human Pose Estimation](#link7)
**Authors:** Quang Dang Huynh, Xuefei Yin, Andrew Busch, Hugo G. Espinosa, Alan Wee-Chung Liew, Matthew T. O. Worsey, Yanming Zhu

8. [KLDrive: Fine-Grained 3D Scene Reasoning for Autonomous Driving based on Knowledge Graph](#link8)
**Authors:** Ye Tian, Jingyi Zhang, Zihao Wang, Xiaoyuan Ren, Xiaofan Yu, Onat Gungor, Tajana Rosing

9. [Manifold-Aware Exploration for Reinforcement Learning in Video Generation](#link9)
...
10. [MARCUS: An agentic, multimodal vision-language model for cardiac diagnosis and management](#link10)
...
11. [A Two-stage Transformer Framework for Temporal Localization of Distracted Driver Behaviors](#link11)
**Authors:** Gia-Bao Doan, Nam-Khoa Huynh, Minh-Nhat-Huy Ho, Khanh-Thanh-Khoa Nguyen, Thanh-Hai Le

12. [Uncertainty-guided Compositional Alignment with Part-to-Whole Semantic Representativeness in Hyperbolic Vision-Language Models](#link12)
**Authors:** Hayeon Kim, Ji Ha Jang, Junghun James Kim, Se Young Chun

13. [FontCrafter: High-Fidelity Element-Driven Artistic Font Creation with Visual In-Context Generation](#link13)
**Authors:** Wuyang Luo, Chengkai Tan, Chang Ge, Binye Hong, Su Yang, Yongjiu Ma

14. [GraphiContact: Pose-aware Human-Scene Robust Contact Perception for Interactive Systems](#link14)
**Authors:** Xiaojian Lin, Yaomin Shen, Junyuan Ma, Yujie Sun, Chengqing Bu, Wenxin Zhang, Zongzheng Zhang, Hao Fei, Lei Jin, Hao Zhao

15. [Mamba Learns in Context: Structure-Aware Domain Generalization for Multi-Task Point Cloud Understanding](#link15)
**Authors:** Jincen Jiang, Qianyu Zhou, Yuhang Li, Kui Su, Meili Wang, Jian Chang, Jian Jun Zhang, Xuequan Lu

16. [Remote Sensing Image Dehazing: A Systematic Review of Progress, Challenges, and Prospects](#link16)
**Authors:** Heng Zhou, Xiaoxiong Liu, Zhenxi Zhang, Jieheng Yun, Chengyang Li, Yunchu Yang, Dongyi Xia, Chunna Tian, Xiao-Jun Wu

17. [Relax Forcing: Relaxed KV-Memory for Consistent Long Video Generation](#link17)
**Authors:** Zengqun Zhao, Yanzuo Lu, Ziquan Liu, Jifei Song, Jiankang Deng, Ioannis Patras

18. [Incentivizing Generative Zero-Shot Learning via Outcome-Reward Reinforcement Learning with Visual Cues](#link18)
**Authors:** Wenjin Hou, Xiaoxiao Sun, Hehe Fan

19. [Improving Diffusion Generalization with Weak-to-Strong Segmented Guidance](#link19)
**Authors:** Liangyu Yuan, Yufei Huang, Mingkun Lei, Tong Zhao, Ruoyu Wang, Changxi Chi, Yiwei Wang, Chi Zhang

20. [WorldCache: Content-Aware Caching for Accelerated Video World Models](#link20)
**Authors:** Umair Nawaz, Ahmed Heakl, Ufaq Khan, Abdelrahman Shaker, Salman Khan, Fahad Shahbaz Khan

21. [A Large-Scale Remote Sensing Dataset and VLM-based Algorithm for Fine-Grained Road Hierarchy Classification](#link21)
**Authors:** Ting Han, Xiangyi Xie, Yiping Chen, Yumeng Du, Jin Ma, Aiguang Li, Jiaan Liu, Yin Gao

22. [KHMP: Frequency-Domain Kalman Refinement for High-Fidelity Human Motion Prediction](#link22)
**Authors:** Wenhan Wu, Zhishuai Guo, Chen Chen, Srijan Das, Hongfei Xue, Pu Wang, Aidong Lu

23. [A transformer architecture alteration to incentivise externalised reasoning](#link23)
**Authors:** Elizabeth Pavlova, Mariia Koroliuk, Karthik Viswanathan, Cameron Tice, Edward James Young, Puria Radmard

24. [Toward a Multi-View Brain Network Foundation Model: Cross-View Consistency Learning Across Arbitrary Atlases](#link24)
**Authors:** Jiaxing Xu, Jingying Ma, Xin Lin, Yuxiao Liu, Kai He, Qika Lin, Yiping Ke, Yang Li, Dinggang Shen, Mengling Feng

25. [Parameter-efficient Prompt Tuning and Hierarchical Textual Guidance for Few-shot Whole Slide Image Classification](#link25)
**Authors:** Jayanie Bogahawatte, Sachith Seneviratne, Saman Halgamuge

26. [GenOpticalFlow: A Generative Approach to Unsupervised Optical Flow Learning](#link26)
**Authors:** Yixuan Luo, Feng Qiao, Zhexiao Xiong, Yanjing Li, Nathan Jacobs

27. [The Reasoning Error About Reasoning: Why Different Types of Reasoning Require Different Representational Structures](#link27)
**Authors:** Yiling Wu

28. [DCG-Net: Dual Cross-Attention with Concept-Value Graph Reasoning for Interpretable Medical Diagnosis](#link28)
**Authors:** Getamesay Dagnaw, Xuefei Yin, Muhammad Hassan Maqsood, Yanming Zhu, Alan Wee-Chung Liew

29. [Cascade-Free Mandarin Visual Speech Recognition via Semantic-Guided Cross-Representation Alignment](#link29)
**Authors:** Lei Yang, Yi He, Fei Wu, Shilin Wang

30. [MEMO: Human-like Crisp Edge Detection Using Masked Edge Prediction](#link30)
**Authors:** Jiaxin Cheng, Yue Wu, Yicong Zhou

31. [Privacy-Preserving Federated Action Recognition via Differentially Private Selective Tuning and Efficient Communication](#link31)
...
32. [HACMatch Semi-Supervised Rotation Regression with Hardness-Aware Curriculum Pseudo Labeling](#link32)
**Authors:** Mei Li, Huayi Zhou, Suizhi Huang, Yuxiang Lu, Yue Ding, Hongtao Lu

33. [Positional Segmentor-Guided Counterfactual Fine-Tuning for Spatially Localized Image Synthesis](#link33)
...
34. [STENet: Superpixel Token Enhancing Network for RGB-D Salient Object Detection](#link34)
**Authors:** Jianlin Chen, Gongyang Li, Zhijiang Zhang, Liang Chang, Dan Zeng

---
## 0. [DualCoT-VLA: Visual-Linguistic Chain of Thought via Parallel Reasoning for Vision-Language-Action Models](https://arxiv.org/abs/2603.22280) <a id="link0"></a>
**ArXiv ID:** 2603.22280
**Authors:** Zhide Zhong, Junfeng Li, Junjie He, Haodong Yan, Xin Gong, Guanyi Zhao, Yingjie Cai, Jiantao Gao, Xu Yan, Bingbing Liu, Yingcong Chen, Liuqing Yang, Haoang Li
...
**Comment:** Matches criteria 1 and 3 as it introduces a novel method for spatial reasoning and embodied agents in Vision-Language-Action models.
**Relevance:** 10
**Novelty:** 8

---

## 1. [The Universal Normal Embedding](https://arxiv.org/abs/2603.21786) <a id="link1"></a>
**ArXiv ID:** 2603.21786
**Authors:** Chen Tasker, Roy Betser, Eyal Gofer, Meir Yossef Levi, Guy Gilboa
...
**Comment:** Matches criterion 5 (Integration of Image/Video and Large Language Models) as it explores shared latent geometry linking encoding and generation.
**Relevance:** 9
**Novelty:** 8

---

## 2. [Speed by Simplicity: A Single-Stream Architecture for Fast Audio-Video Generative Foundation Model](https://arxiv.org/abs/2603.21986) <a id="link2"></a>
**ArXiv ID:** 2603.21986
**Authors:** SII-GAIR, Sand. ai, :, Ethan Chern, Hansi Teng, Hanwen Sun, Hao Wang, Hong Pan, Hongyu Jia, Jiadi Su, Jin Li, Junjie Yu, Lijie Liu, Lingzhi Li, Lyumanshan Ye, Min Hu, Qiangang Wang, Quanwei Qi, Steffi Chern, Tao Bu, Taoran Wang, Teren Xu, Tianning Zhang, Tiantian Mi, Weixian Xu, Wenqiang Zhang, Wentai Zhang, Xianping Yi, Xiaojie Cai, Xiaoyang Kang, Yan Ma, Yixiu Liu, Yunbo Zhang, Yunpeng Huang, Yutong Lin, Zewei Tao, Zhaoliang Liu, Zheng Zhang, Zhiyao Cen, Zhixuan Yu, Zhongshu Wang, Zhulin Hu, Zijin Zhou, Zinan Guo, Yue Cao, Pengfei Liu
...
**Comment:** Matches criteria 5 as it integrates audio and video generation tasks with a unified model.
**Relevance:** 9
**Novelty:** 8

---

## 3. [VGS-Decoding: Visual Grounding Score Guided Decoding for Hallucination Mitigation in Medical VLMs](https://arxiv.org/abs/2603.20314) <a id="link3"></a>
**ArXiv ID:** 2603.20314
**Authors:** Govinda Kolli, Adinath Madhavrao Dukre, Behzad Bozorgtabar, Dwarikanath Mahapatra, Imran Razzak
...
**Comment:** Matches criterion 2 (Visual and Multimodal Large Language Models) as it addresses hallucination mitigation in medical vision-language models.
**Relevance:** 9
**Novelty:** 7

---

## 4. [FreeArtGS: Articulated Gaussian Splatting Under Free-moving Scenario](https://arxiv.org/abs/2603.22102) <a id="link4"></a>
**ArXiv ID:** 2603.22102
**Authors:** Hang Dai, Hongwei Fan, Han Zhang, Duojin Wu, Jiyao Zhang, Hao Dong
...
**Comment:** Matches criteria 3 as it introduces a new method for articulated object reconstruction, relevant to embodied/robotic AI.
**Relevance:** 9
**Novelty:** 7

---

## 5. [Learning Progressive Adaptation for Multi-Modal Tracking](https://arxiv.org/abs/2603.21100) <a id="link5"></a>
**ArXiv ID:** 2603.21100
**Authors:** He Wang, Tianyang Xu, Zhangyong Tang, Xiao-Jun Wu, Josef Kittler
...
**Comment:** Matches criterion 5 (Integration of Image/Video and Large Language Models) as it focuses on multi-modal tracking with progressive adaptation.
**Relevance:** 8
**Novelty:** 7

---

## 6. [Transparent Fragments Contour Estimation via Visual-Tactile Fusion for Autonomous Reassembly](https://arxiv.org/abs/2603.20290) <a id="link6"></a>
**ArXiv ID:** 2603.20290
**Authors:** Qihao Lin, Borui Chen, Yuping Zhou, Jianing Wu, Yulan Guo, Weishi Zheng, Chongkun Xia
...
**Comment:** Matches criterion 3 (Embodied/Robotic AI: New Benchmarks or Methods) as it introduces a framework for contour estimation and reassembly using visual-tactile fusion.
**Relevance:** 8
**Novelty:** 7

---

## 7. [NCSTR: Node-Centric Decoupled Spatio-Temporal Reasoning for Video-based Human Pose Estimation](https://arxiv.org/abs/2603.20323) <a id="link7"></a>
**ArXiv ID:** 2603.20323
**Authors:** Quang Dang Huynh, Xuefei Yin, Andrew Busch, Hugo G. Espinosa, Alan Wee-Chung Liew, Matthew T. O. Worsey, Yanming Zhu
...
**Comment:** Matches criterion 6 (Video Understanding) as it focuses on video-based human pose estimation with novel methodologies.
**Relevance:** 8
**Novelty:** 7

---

## 8. [KLDrive: Fine-Grained 3D Scene Reasoning for Autonomous Driving based on Knowledge Graph](https://arxiv.org/abs/2603.21029) <a id="link8"></a>
**ArXiv ID:** 2603.21029
**Authors:** Ye Tian, Jingyi Zhang, Zihao Wang, Xiaoyuan Ren, Xiaofan Yu, Onat Gungor, Tajana Rosing
...
**Comment:** Matches criterion 3 (Embodied/Robotic AI: New Benchmarks or Methods) as it introduces a knowledge-graph-augmented reasoning framework for autonomous driving, which is a novel benchmark for embodied AI.
**Relevance:** 8
**Novelty:** 7

---

## 9. [Manifold-Aware Exploration for Reinforcement Learning in Video Generation](https://arxiv.org/abs/2603.21872) <a id="link9"></a>
**ArXiv ID:** 2603.21872
**Authors:** Mingzhe Zheng, Weijie Kong, Yue Wu, Dengyang Jiang, Yue Ma, Xuanhua He, Bin Lin, Kaixiong Gong, Zhao Zhong, Liefeng Bo, Qifeng Chen, Harry Yang
...
**Comment:** Matches criteria 6 as it focuses on video generation and understanding with novel reinforcement learning methods.
**Relevance:** 8
**Novelty:** 7

---

## 10. [MARCUS: An agentic, multimodal vision-language model for cardiac diagnosis and management](https://arxiv.org/abs/2603.22179) <a id="link10"></a>
**ArXiv ID:** 2603.22179
**Authors:** Jack W O'Sullivan, Mohammad Asadi, Lennart Elbe, Akshay Chaudhari, Tahoura Nedaee, Francois Haddad, Michael Salerno, Li Fe-Fei, Ehsan Adeli, Rima Arnaout, Euan A Ashley
...
**Comment:** Matches criterion 2 (Visual and Multimodal Large Language Models) as it introduces a multimodal vision-language model for cardiac diagnosis, integrating vision and language inputs.
**Relevance:** 7
**Novelty:** 7

---

## 11. [A Two-stage Transformer Framework for Temporal Localization of Distracted Driver Behaviors](https://arxiv.org/abs/2603.21048) <a id="link11"></a>
**ArXiv ID:** 2603.21048
**Authors:** Gia-Bao Doan, Nam-Khoa Huynh, Minh-Nhat-Huy Ho, Khanh-Thanh-Khoa Nguyen, Thanh-Hai Le
...
**Comment:** Matches criteria 6 as it focuses on temporal localization in video understanding tasks.
**Relevance:** 8
**Novelty:** 6

---

## 12. [Uncertainty-guided Compositional Alignment with Part-to-Whole Semantic Representativeness in Hyperbolic Vision-Language Models](https://arxiv.org/abs/2603.22042) <a id="link12"></a>
**ArXiv ID:** 2603.22042
**Authors:** Hayeon Kim, Ji Ha Jang, Junghun James Kim, Se Young Chun
...
**Comment:** Matches criterion 5 (Integration of Image/Video and Large Language Models) as it focuses on uncertainty-guided compositional alignment in hyperbolic vision-language models.
**Relevance:** 7
**Novelty:** 6

---

## 13. [FontCrafter: High-Fidelity Element-Driven Artistic Font Creation with Visual In-Context Generation](https://arxiv.org/abs/2603.22054) <a id="link13"></a>
**ArXiv ID:** 2603.22054
**Authors:** Wuyang Luo, Chengkai Tan, Chang Ge, Binye Hong, Su Yang, Yongjiu Ma
...
**Comment:** Matches criterion 5 (Integration of Image/Video and Large Language Models) as it proposes a method for compositional alignment in hyperbolic vision-language models.
**Relevance:** 7
**Novelty:** 6

---

## 14. [GraphiContact: Pose-aware Human-Scene Robust Contact Perception for Interactive Systems](https://arxiv.org/abs/2603.20310) <a id="link14"></a>
**ArXiv ID:** 2603.20310
**Authors:** Xiaojian Lin, Yaomin Shen, Junyuan Ma, Yujie Sun, Chengqing Bu, Wenxin Zhang, Zongzheng Zhang, Hao Fei, Lei Jin, Hao Zhao
...
**Comment:** Matches criterion 3 (Embodied/Robotic AI: New Benchmarks or Methods) as it introduces a framework for human-scene contact prediction, relevant for embodied AI applications.
**Relevance:** 7
**Novelty:** 6

---

## 15. [Mamba Learns in Context: Structure-Aware Domain Generalization for Multi-Task Point Cloud Understanding](https://arxiv.org/abs/2603.20739) <a id="link15"></a>
**ArXiv ID:** 2603.20739
**Authors:** Jincen Jiang, Qianyu Zhou, Yuhang Li, Kui Su, Meili Wang, Jian Chang, Jian Jun Zhang, Xuequan Lu
...
**Comment:** This paper matches criterion 3 (Embodied/Robotic AI: New Benchmarks or Methods) as it introduces a new dataset (MP3DObject) and methods for multi-task domain generalization in point cloud understanding.
**Relevance:** 5
**Novelty:** 7

---

## 16. [Remote Sensing Image Dehazing: A Systematic Review of Progress, Challenges, and Prospects](https://arxiv.org/abs/2603.20289) <a id="link16"></a>
**ArXiv ID:** 2603.20289
**Authors:** Heng Zhou, Xiaoxiong Liu, Zhenxi Zhang, Jieheng Yun, Chengyang Li, Yunchu Yang, Dongyi Xia, Chunna Tian, Xiao-Jun Wu
...
**Comment:** Matches criterion 7 (Vision-Focused Survey Papers) as it is a comprehensive survey on remote sensing image dehazing.
**Relevance:** 7
**Novelty:** 5

---

## 17. [Relax Forcing: Relaxed KV-Memory for Consistent Long Video Generation](https://arxiv.org/abs/2603.21366) <a id="link17"></a>
**ArXiv ID:** 2603.21366
**Authors:** Zengqun Zhao, Yanzuo Lu, Ziquan Liu, Jifei Song, Jiankang Deng, Ioannis Patras
...
**Comment:** Matches criterion 6 (Video Understanding) as it focuses on long video generation and introduces a novel structured temporal memory mechanism.
**Relevance:** 6
**Novelty:** 6

---

## 18. [Incentivizing Generative Zero-Shot Learning via Outcome-Reward Reinforcement Learning with Visual Cues](https://arxiv.org/abs/2603.21138) <a id="link18"></a>
**ArXiv ID:** 2603.21138
**Authors:** Wenjin Hou, Xiaoxiao Sun, Hehe Fan
...
**Comment:** Matches criterion 1 (Spatial Intelligence and Embodied Agents) due to its focus on generative zero-shot learning with visual cues and reinforcement learning, which could be relevant for embodied agents.
**Relevance:** 6
**Novelty:** 6

---

## 19. [Improving Diffusion Generalization with Weak-to-Strong Segmented Guidance](https://arxiv.org/abs/2603.20584) <a id="link19"></a>
**ArXiv ID:** 2603.20584
**Authors:** Liangyu Yuan, Yufei Huang, Mingkun Lei, Tong Zhao, Ruoyu Wang, Changxi Chi, Yiwei Wang, Chi Zhang
...
**Comment:** This paper matches criterion 4 (Vision Foundation Models and Their Applications) as it focuses on improving diffusion models, which are foundational in generative vision tasks.
**Relevance:** 5
**Novelty:** 6

---

## 20. [WorldCache: Content-Aware Caching for Accelerated Video World Models](https://arxiv.org/abs/2603.22286) <a id="link20"></a>
**ArXiv ID:** 2603.22286
**Authors:** Umair Nawaz, Ahmed Heakl, Ufaq Khan, Abdelrahman Shaker, Salman Khan, Fahad Shahbaz Khan
...
**Comment:** This paper matches criterion 6 (Video Understanding) as it focuses on accelerating video world models with novel caching techniques.
**Relevance:** 5
**Novelty:** 6

---

## 21. [A Large-Scale Remote Sensing Dataset and VLM-based Algorithm for Fine-Grained Road Hierarchy Classification](https://arxiv.org/abs/2603.21222) <a id="link21"></a>
**ArXiv ID:** 2603.21222
**Authors:** Ting Han, Xiangyi Xie, Yiping Chen, Yumeng Du, Jin Ma, Aiguang Li, Jiaan Liu, Yin Gao
...
**Comment:** Matches criterion 4 (Vision Foundation Models and Their Applications) as it introduces a large-scale dataset and a vision-language framework for road mapping, which is an application of vision models.
**Relevance:** 5
**Novelty:** 5

---

## 22. [KHMP: Frequency-Domain Kalman Refinement for High-Fidelity Human Motion Prediction](https://arxiv.org/abs/2603.21327) <a id="link22"></a>
**ArXiv ID:** 2603.21327
**Authors:** Wenhan Wu, Zhishuai Guo, Chen Chen, Srijan Das, Hongfei Xue, Pu Wang, Aidong Lu
...
**Comment:** This paper does not match any specific criteria but focuses on human motion prediction, which is tangentially related to embodied AI.
**Relevance:** 3
**Novelty:** 6

---

## 23. [A transformer architecture alteration to incentivise externalised reasoning](https://arxiv.org/abs/2603.21376) <a id="link23"></a>
**ArXiv ID:** 2603.21376
**Authors:** Elizabeth Pavlova, Mariia Koroliuk, Karthik Viswanathan, Cameron Tice, Edward James Young, Puria Radmard
...
**Comment:** Does not closely match any specific criterion but is relevant to transformer architecture and reasoning models.
**Relevance:** 3
**Novelty:** 6

---

## 24. [Toward a Multi-View Brain Network Foundation Model: Cross-View Consistency Learning Across Arbitrary Atlases](https://arxiv.org/abs/2603.20348) <a id="link24"></a>
**ArXiv ID:** 2603.20348
**Authors:** Jiaxing Xu, Jingying Ma, Xin Lin, Yuxiao Liu, Kai He, Qika Lin, Yiping Ke, Yang Li, Dinggang Shen, Mengling Feng
...
**Comment:** Does not closely match any specific criterion but is relevant to foundation models in brain network analysis.
**Relevance:** 3
**Novelty:** 6

---

## 25. [Parameter-efficient Prompt Tuning and Hierarchical Textual Guidance for Few-shot Whole Slide Image Classification](https://arxiv.org/abs/2603.21504) <a id="link25"></a>
**ArXiv ID:** 2603.21504
**Authors:** Jayanie Bogahawatte, Sachith Seneviratne, Saman Halgamuge
...
**Comment:** Does not closely match any specific criterion but is relevant to vision-language integration and machine learning applications.
**Relevance:** 3
**Novelty:** 6

---

## 26. [GenOpticalFlow: A Generative Approach to Unsupervised Optical Flow Learning](https://arxiv.org/abs/2603.22270) <a id="link26"></a>
**ArXiv ID:** 2603.22270
**Authors:** Yixuan Luo, Feng Qiao, Zhexiao Xiong, Yanjing Li, Nathan Jacobs
...
## 27. [The Reasoning Error About Reasoning: Why Different Types of Reasoning Require Different Representational Structures](https://arxiv.org/abs/2603.21736) <a id="link27"></a>
**ArXiv ID:** 2603.21736
**Authors:** Yiling Wu
...
## 28. [DCG-Net: Dual Cross-Attention with Concept-Value Graph Reasoning for Interpretable Medical Diagnosis](https://arxiv.org/abs/2603.20325) <a id="link28"></a>
**ArXiv ID:** 2603.20325
**Authors:** Getamesay Dagnaw, Xuefei Yin, Muhammad Hassan Maqsood, Yanming Zhu, Alan Wee-Chung Liew
...
**Comment:** This paper does not match any specific criteria but explores interpretable medical diagnosis using multimodal alignment, which is tangentially related to vision-language integration.
**Relevance:** 3
**Novelty:** 5

---

## 29. [Cascade-Free Mandarin Visual Speech Recognition via Semantic-Guided Cross-Representation Alignment](https://arxiv.org/abs/2603.21808) <a id="link29"></a>
**ArXiv ID:** 2603.21808
**Authors:** Lei Yang, Yi He, Fei Wu, Shilin Wang
...
**Comment:** This paper does not match any specific criteria but is related to visual speech recognition, which is tangentially related to vision-language integration.
**Relevance:** 3
**Novelty:** 5

---

## 30. [MEMO: Human-like Crisp Edge Detection Using Masked Edge Prediction](https://arxiv.org/abs/2603.20782) <a id="link30"></a>
**ArXiv ID:** 2603.20782
**Authors:** Jiaxin Cheng, Yue Wu, Yicong Zhou
...
## 31. [Privacy-Preserving Federated Action Recognition via Differentially Private Selective Tuning and Efficient Communication](https://arxiv.org/abs/2603.21305) <a id="link31"></a>
**ArXiv ID:** 2603.21305
**Authors:** Idris Zakariyya, Pai Chet Ng, Kaushik Bhargav Sivangi, S. Mohammad Sheikholeslami, Konstantinos N. Plataniotis, Fani Deligianni
...
## 32. [HACMatch Semi-Supervised Rotation Regression with Hardness-Aware Curriculum Pseudo Labeling](https://arxiv.org/abs/2603.21583) <a id="link32"></a>
**ArXiv ID:** 2603.21583
**Authors:** Mei Li, Huayi Zhou, Suizhi Huang, Yuxiang Lu, Yue Ding, Hongtao Lu
...
## 33. [Positional Segmentor-Guided Counterfactual Fine-Tuning for Spatially Localized Image Synthesis](https://arxiv.org/abs/2603.21213) <a id="link33"></a>
**ArXiv ID:** 2603.21213
**Authors:** Tian Xia, Matthew Sinclair, Andreas Schuh, Fabio De Sousa Ribeiro, Raghav Mehta, Rajat Rasal, Esther Puyol-Ant\'on, Samuel Gerber, Kersten Petersen, Michiel Schaap, Ben Glocker
...
## 34. [STENet: Superpixel Token Enhancing Network for RGB-D Salient Object Detection](https://arxiv.org/abs/2603.21999) <a id="link34"></a>
**ArXiv ID:** 2603.21999
**Authors:** Jianlin Chen, Gongyang Li, Zhijiang Zhang, Liang Chang, Dan Zeng
...
**Comment:** Does not closely match any specific criterion but is relevant to computer vision and machine learning due to its focus on RGB-D Salient Object Detection.
**Relevance:** 3
**Novelty:** 4
