...
0. [LumosX: Relate Any Identities with Their Attributes for Personalized Video Generation](#link0)
**Authors:** Jiazheng Xing, Fei Du, Hangjie Yuan, Pengwei Liu, Hongbin Xu, Hai Ci, Ruigang Niu, Weihua Chen, Fan Wang, Yong Liu

1. [ParallelVLM: Lossless Video-LLM Acceleration with Visual Alignment Aware Parallel Speculative Decoding](#link1)
**Authors:** Quan Kong, Yuhao Shen, Yicheng Ji, Huan Li, Cong Wang

2. [MagicSeg: Open-World Segmentation Pretraining via Counterfactural Diffusion-Based Auto-Generation](#link2)
**Authors:** Kaixin Cai, Pengzhen Ren, Jianhua Han, Yi Zhu, Hang Xu, Jianzhuang Liu, Xiaodan Liang

3. [FREAK: A Fine-grained Hallucination Evaluation Benchmark for Advanced MLLMs](#link3)
**Authors:** Zhihan Yin, Jianxin Liang, Yueqian Wang, Yifeng Yao, Huishuai Zhang, Dongyan Zhao

4. [Controllable Text-to-Motion Generation via Modular Body-Part Phase Control](#link4)
**Authors:** Minyue Dai, Ke Fan, Anyi Rao, Jingbo Wang, Bo Dai

5. [Adaptive Greedy Frame Selection for Long Video Understanding](#link5)
**Authors:** Yuning Huang, Fengqing Zhu

6. [LoD-Loc v3: Generalized Aerial Localization in Dense Cities using Instance Silhouette Alignment](#link6)
**Authors:** Shuaibang Peng, Juelin Zhu, Xia Li, Kun Yang, Maojun Zhang, Yu Liu, Shen Yan

7. [Chain-of-Adaptation: Surgical Vision-Language Adaptation with Reinforcement Learning](#link7)
**Authors:** Jiajie Li, Chenhui Xu, Meihuan Liu, Jinjun Xiong

8. [Physion-Eval: Evaluating Physical Realism in Generated Video via Human Reasoning](#link8)
**Authors:** Qin Zhang, Peiyu Jing, Hong-Xing Yu, Fangqiang Ding, Fan Nie, Weimin Wang, Yilun Du, James Zou, Jiajun Wu, Bing Shuai

9. [MuSteerNet: Human Reaction Generation from Videos via Observation-Reaction Mutual Steering](#link9)
**Authors:** Yuan Zhou, Yongzhi Li, Yanqi Dai, Xingyu Zhu, Yi Tan, Qingshan Xu, Beier Zhu, Richang Hong, Hanwang Zhang

10. [One Model, Two Minds: Task-Conditioned Reasoning for Unified Image Quality and Aesthetic Assessment](#link10)
**Authors:** Wen Yin, Cencen Liu, Dingrui Liu, Bing Su, Yuan-Fang Li, Tao He

11. [From Plausibility to Verifiability: Risk-Controlled Generative OCR for Vision-Language Models](#link11)
**Authors:** Weile Gong, Yiping Zuo, Zijian Lu, Xin He, Weibei Fan, Chen Dai

12. [Narrative Aligned Long Form Video Question Answering](#link12)
**Authors:** Rahul Jain, Keval Doshi, Burak Uzkent, Garin Kessler

13. [Teaching an Agent to Sketch One Part at a Time](#link13)
**Authors:** Xiaodan Du, Ruize Xu, David Yunis, Yael Vinker, Greg Shakhnarovich

14. [Adapting a Pre-trained Single-Cell Foundation Model to Spatial Gene Expression Generation from Histology Images](#link14)
**Authors:** Donghai Fang, Yongheng Li, Zhen Wang, Yuansong Zeng, Wenwen Min

15. [Dual Prompt-Driven Feature Encoding for Nighttime UAV Tracking](#link15)
**Authors:** Yiheng Wang, Changhong Fu, Liangliang Yao, Haobo Zuo, Zijie Zhang

16. [Evaluating Vision Foundation Models for Pixel and Object Classification in Microscopy](#link16)
**Authors:** Carolin Teuber, Anwai Archit, Tobias Boothe, Peter Ditte, Jochen Rink, Constantin Pape

17. [HyEvo: Self-Evolving Hybrid Agentic Workflows for Efficient Reasoning](#link17)
**Authors:** Beibei Xu, Yutong Ye, Chuyun Shen, Yingbo Zhou, Cheng Chen, Mingsong Chen

18. [In-the-Wild Camouflage Attack on Vehicle Detectors through Controllable Image Editing](#link18)
**Authors:** Xiao Fang, Yiming Gong, Stanislav Panev, Celso de Melo, Shuowen Hu, Shayok Chakraborty, Fernando De la Torre

19. [Dual-Domain Representation Alignment: Bridging 2D and 3D Vision via Geometry-Aware Architecture Search](#link19)
**Authors:** Haoyu Zhang, Zhihao Yu, Rui Wang, Yaochu Jin, Qiqi Liu, Ran Cheng

20. [PhysNeXt: Next-Generation Dual-Branch Structured Attention Fusion Network for Remote Photoplethysmography Measurement](#link20)
**Authors:** Junzhe Cao, Bo Zhao, Zhiyi Niu, Dan Guo, Yue Sun, Haochen Liang, Yong Xu, Zitong YU

---
## 0. [LumosX: Relate Any Identities with Their Attributes for Personalized Video Generation](https://arxiv.org/abs/2603.20192) <a id="link0"></a>
**ArXiv ID:** 2603.20192
**Authors:** Jiazheng Xing, Fei Du, Hangjie Yuan, Pengwei Liu, Hongbin Xu, Hai Ci, Ruigang Niu, Weihua Chen, Fan Wang, Yong Liu
...
**Comment:** Matches criterion 5 as it integrates multimodal large language models (MLLMs) for personalized video generation.
**Relevance:** 9
**Novelty:** 8

---

## 1. [ParallelVLM: Lossless Video-LLM Acceleration with Visual Alignment Aware Parallel Speculative Decoding](https://arxiv.org/abs/2603.19610) <a id="link1"></a>
**ArXiv ID:** 2603.19610
**Authors:** Quan Kong, Yuhao Shen, Yicheng Ji, Huan Li, Cong Wang
...
**Comment:** Matches criteria 2 (Visual and Multimodal Large Language Models) and 5 (Integration of Image/Video and Large Language Models) due to its focus on accelerating Video-LLMs and improving video token processing.
**Relevance:** 9
**Novelty:** 8

---

## 2. [MagicSeg: Open-World Segmentation Pretraining via Counterfactural Diffusion-Based Auto-Generation](https://arxiv.org/abs/2603.19575) <a id="link2"></a>
**ArXiv ID:** 2603.19575
**Authors:** Kaixin Cai, Pengzhen Ren, Jianhua Han, Yi Zhu, Hang Xu, Jianzhuang Liu, Xiaodan Liang
...
**Comment:** Matches criterion 4 as it focuses on open-world segmentation using diffusion models, which aligns with vision foundation models.
**Relevance:** 8
**Novelty:** 8

---

## 3. [FREAK: A Fine-grained Hallucination Evaluation Benchmark for Advanced MLLMs](https://arxiv.org/abs/2603.19765) <a id="link3"></a>
**ArXiv ID:** 2603.19765
**Authors:** Zhihan Yin, Jianxin Liang, Yueqian Wang, Yifeng Yao, Huishuai Zhang, Dongyan Zhao
...
**Comment:** This paper matches criterion 2 as it explores Multimodal Large Language Models (MLLMs) and introduces a novel benchmark (FREAK) for fine-grained hallucination evaluation in MLLMs. It also provides insights into hallucination patterns and reasoning processes, which aligns with vision–language integration.
**Relevance:** 8
**Novelty:** 7

---

## 4. [Controllable Text-to-Motion Generation via Modular Body-Part Phase Control](https://arxiv.org/abs/2603.19795) <a id="link4"></a>
**ArXiv ID:** 2603.19795
**Authors:** Minyue Dai, Ke Fan, Anyi Rao, Jingbo Wang, Bo Dai
...
**Comment:** Matches criterion 5 as it focuses on controllable text-to-motion generation, integrating text and motion understanding.
**Relevance:** 8
**Novelty:** 7

---

## 5. [Adaptive Greedy Frame Selection for Long Video Understanding](https://arxiv.org/abs/2603.20180) <a id="link5"></a>
**ArXiv ID:** 2603.20180
**Authors:** Yuning Huang, Fengqing Zhu
...
**Comment:** Matches criterion 6 as it proposes a method for long video understanding with adaptive frame selection.
**Relevance:** 8
**Novelty:** 7

---

## 6. [LoD-Loc v3: Generalized Aerial Localization in Dense Cities using Instance Silhouette Alignment](https://arxiv.org/abs/2603.19609) <a id="link6"></a>
**ArXiv ID:** 2603.19609
**Authors:** Shuaibang Peng, Juelin Zhu, Xia Li, Kun Yang, Maojun Zhang, Yu Liu, Shen Yan
...
**Comment:** Matches criterion 3 as it introduces a new dataset and method for aerial localization in dense urban environments.
**Relevance:** 8
**Novelty:** 7

---

## 7. [Chain-of-Adaptation: Surgical Vision-Language Adaptation with Reinforcement Learning](https://arxiv.org/abs/2603.20116) <a id="link7"></a>
**ArXiv ID:** 2603.20116
**Authors:** Jiajie Li, Chenhui Xu, Meihuan Liu, Jinjun Xiong
...
**Comment:** Matches criterion 2 as it explores a novel adaptation framework for vision-language models (VLMs) with reinforcement learning.
**Relevance:** 8
**Novelty:** 7

---

## 8. [Physion-Eval: Evaluating Physical Realism in Generated Video via Human Reasoning](https://arxiv.org/abs/2603.19607) <a id="link8"></a>
**ArXiv ID:** 2603.19607
**Authors:** Qin Zhang, Peiyu Jing, Hong-Xing Yu, Fangqiang Ding, Fan Nie, Weimin Wang, Yilun Du, James Zou, Jiajun Wu, Bing Shuai
...
**Comment:** Matches criteria 6 (Video Understanding) due to its focus on evaluating physical realism in generated videos.
**Relevance:** 8
**Novelty:** 7

---

## 9. [MuSteerNet: Human Reaction Generation from Videos via Observation-Reaction Mutual Steering](https://arxiv.org/abs/2603.20187) <a id="link9"></a>
**ArXiv ID:** 2603.20187
**Authors:** Yuan Zhou, Yongzhi Li, Yanqi Dai, Xingyu Zhu, Yi Tan, Qingshan Xu, Beier Zhu, Richang Hong, Hanwang Zhang
...
**Comment:** Matches criteria 3 (Embodied/Robotic AI: New Benchmarks or Methods) due to its focus on video-driven human reaction generation for interactive AI systems.
**Relevance:** 8
**Novelty:** 7

---

## 10. [One Model, Two Minds: Task-Conditioned Reasoning for Unified Image Quality and Aesthetic Assessment](https://arxiv.org/abs/2603.19779) <a id="link10"></a>
**ArXiv ID:** 2603.19779
**Authors:** Wen Yin, Cencen Liu, Dingrui Liu, Bing Su, Yuan-Fang Li, Tao He
...
**Comment:** Matches criteria 2 (Visual and Multimodal Large Language Models) due to its unified framework for image quality and aesthetic assessment using multimodal LLMs.
**Relevance:** 8
**Novelty:** 7

---

## 11. [From Plausibility to Verifiability: Risk-Controlled Generative OCR for Vision-Language Models](https://arxiv.org/abs/2603.19790) <a id="link11"></a>
**ArXiv ID:** 2603.19790
**Authors:** Weile Gong, Yiping Zuo, Zijian Lu, Xin He, Weibei Fan, Chen Dai
...
**Comment:** Matches criteria 2 (Visual and Multimodal Large Language Models) due to its focus on generative OCR using vision-language models.
**Relevance:** 8
**Novelty:** 7

---

## 12. [Narrative Aligned Long Form Video Question Answering](https://arxiv.org/abs/2603.19481) <a id="link12"></a>
**ArXiv ID:** 2603.19481
**Authors:** Rahul Jain, Keval Doshi, Burak Uzkent, Garin Kessler
...
**Comment:** Matches criteria 6 (Video Understanding) due to its focus on long-form video question answering and narrative reasoning.
**Relevance:** 8
**Novelty:** 7

---

## 13. [Teaching an Agent to Sketch One Part at a Time](https://arxiv.org/abs/2603.19500) <a id="link13"></a>
**ArXiv ID:** 2603.19500
**Authors:** Xiaodan Du, Ruize Xu, David Yunis, Yael Vinker, Greg Shakhnarovich
...
**Comment:** Matches criteria 3 (Embodied/Robotic AI: New Benchmarks or Methods) due to its novel dataset and method for sketch generation.
**Relevance:** 7
**Novelty:** 7

---

## 14. [Adapting a Pre-trained Single-Cell Foundation Model to Spatial Gene Expression Generation from Histology Images](https://arxiv.org/abs/2603.19766) <a id="link14"></a>
**ArXiv ID:** 2603.19766
**Authors:** Donghai Fang, Yongheng Li, Zhen Wang, Yuansong Zeng, Wenwen Min
...
**Comment:** Matches criterion 4 as it adapts a single-cell foundation model for spatial gene expression generation, which involves vision foundation models.
**Relevance:** 7
**Novelty:** 6

---

## 15. [Dual Prompt-Driven Feature Encoding for Nighttime UAV Tracking](https://arxiv.org/abs/2603.19628) <a id="link15"></a>
**ArXiv ID:** 2603.19628
**Authors:** Yiheng Wang, Changhong Fu, Liangliang Yao, Haobo Zuo, Zijie Zhang
...
**Comment:** Matches criterion 3 as it proposes a novel method for nighttime UAV tracking with robust feature encoding.
**Relevance:** 7
**Novelty:** 6

---

## 16. [Evaluating Vision Foundation Models for Pixel and Object Classification in Microscopy](https://arxiv.org/abs/2603.19802) <a id="link16"></a>
**ArXiv ID:** 2603.19802
**Authors:** Carolin Teuber, Anwai Archit, Tobias Boothe, Peter Ditte, Jochen Rink, Constantin Pape
...
**Comment:** Matches criterion 4 as it evaluates vision foundation models (VFMs) for specific applications in microscopy.
**Relevance:** 7
**Novelty:** 6

---

## 17. [HyEvo: Self-Evolving Hybrid Agentic Workflows for Efficient Reasoning](https://arxiv.org/abs/2603.19639) <a id="link17"></a>
**ArXiv ID:** 2603.19639
**Authors:** Beibei Xu, Yutong Ye, Chuyun Shen, Yingbo Zhou, Cheng Chen, Mingsong Chen
...
**Comment:** Does not closely match any specific criteria but is relevant to reasoning and hybrid workflows in AI.
**Relevance:** 3
**Novelty:** 6

---

## 18. [In-the-Wild Camouflage Attack on Vehicle Detectors through Controllable Image Editing](https://arxiv.org/abs/2603.19456) <a id="link18"></a>
**ArXiv ID:** 2603.19456
**Authors:** Xiao Fang, Yiming Gong, Stanislav Panev, Celso de Melo, Shuowen Hu, Shayok Chakraborty, Fernando De la Torre
...
**Comment:** Does not closely match any specific criteria but is relevant to adversarial attacks in computer vision.
**Relevance:** 3
**Novelty:** 6

---

## 19. [Dual-Domain Representation Alignment: Bridging 2D and 3D Vision via Geometry-Aware Architecture Search](https://arxiv.org/abs/2603.19563) <a id="link19"></a>
**ArXiv ID:** 2603.19563
**Authors:** Haoyu Zhang, Zhihao Yu, Rui Wang, Yaochu Jin, Qiqi Liu, Ran Cheng
...
**Comment:** Does not closely match any specific criteria but is relevant to computer vision and multi-objective optimization.
**Relevance:** 3
**Novelty:** 6

---

## 20. [PhysNeXt: Next-Generation Dual-Branch Structured Attention Fusion Network for Remote Photoplethysmography Measurement](https://arxiv.org/abs/2603.19752) <a id="link20"></a>
**ArXiv ID:** 2603.19752
**Authors:** Junzhe Cao, Bo Zhao, Zhiyi Niu, Dan Guo, Yue Sun, Haochen Liang, Yong Xu, Zitong YU
