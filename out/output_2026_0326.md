...
0. [VOLMO: Versatile and Open Large Models for Ophthalmology](#link0)
...
1. [CliPPER: Contextual Video-Language Pretraining on Long-form Intraoperative Surgical Procedures for Event Recognition](#link1)
**Authors:** Florian Stilz, Vinkle Srivastav, Nassir Navab, Nicolas Padoy

2. [COVTrack++: Learning Open-Vocabulary Multi-Object Tracking from Continuous Videos via a Synergistic Paradigm](#link2)
**Authors:** Zekun Qian, Wei Feng, Ruize Han, Junhui Hou

3. [Attention-aware Inference Optimizations for Large Vision-Language Models with Memory-efficient Decoding](#link3)
**Authors:** Fatih Ilhan, Gaowen Liu, Ramana Rao Kompella, Selim Furkan Tekin, Tiansheng Huang, Zachary Yahn, Yichang Xu, Ling Liu

4. [Le MuMo JEPA: Multi-Modal Self-Supervised Representation Learning with Learnable Fusion Tokens](#link4)
**Authors:** Ciem Cornelissen, Sam Leroux, Pieter Simoens

5. [LongTail Driving Scenarios with Reasoning Traces: The KITScenes LongTail Dataset](#link5)
...
6. [Toward Physically Consistent Driving Video World Models under Challenging Trajectories](#link6)
...
7. [MLE-UVAD: Minimal Latent Entropy Autoencoder for Fully Unsupervised Video Anomaly Detection](#link7)
**Authors:** Yuang Geng, Junkai Zhou, Kang Yang, Pan He, Zhuoyang Zhou, Jose C. Principe, Joel Harley, Ivan Ruchkin

8. [VFIG: Vectorizing Complex Figures in SVG with Vision-Language Models](#link8)
**Authors:** Qijia He, Xunmei Liu, Hammaad Memon, Ziang Li, Zixian Ma, Jaemin Cho, Jason Ren, Daniel S Weld, Ranjay Krishna

9. [Knowledge-Refined Dual Context-Aware Network for Partially Relevant Video Retrieval](#link9)
**Authors:** Junkai Yang, Qirui Wang, Yaoqing Jin, Shuai Ma, Minghan Xu, Shanmin Pang

10. [MMTIT-Bench: A Multilingual and Multi-Scenario Benchmark with Cognition-Perception-Reasoning Guided Text-Image Machine Translation](#link10)
...
11. [UW-VOS: A Large-Scale Dataset for Underwater Video Object Segmentation](#link11)
**Authors:** Hongshen Zhao, Jingkang Tai, Yuhang Wu, Wenkang Zhang, Xi Lan, Shangyan Wang, Tianyu Zhang, Wankou Yang

12. [Towards Real-World Document Parsing via Realistic Scene Synthesis and Document-Aware Training](#link12)
**Authors:** Gengluo Li, Chengquan Zhang, Yupu Liang, Huawen Shen, Yaping Zhang, Pengyuan Lyu, Weinong Wang, Xingyu Wan, Gangyan Zeng, Han Hu, Can Ma, Yu Zhou

13. [SynMVCrowd: A Large Synthetic Benchmark for Multi-view Crowd Counting and Localization](#link13)
**Authors:** Qi Zhang, Daijie Chen, Yunfei Gong, Hui Huang

14. [VehicleMemBench: An Executable Benchmark for Multi-User Long-Term Memory in In-Vehicle Agents](#link14)
**Authors:** Yuhao Chen, Yi Xu, Xinyun Ding, Xiang Fang, Shuochen Liu, Luxi Lin, Qingyu Zhang, Ya Li, Quan Liu, Tong Xu

15. [Latent Bias Alignment for High-Fidelity Diffusion Inversion in Real-World Image Reconstruction and Manipulation](#link15)
**Authors:** Weiming Chen, Qifan Liu, Siyi Liu, Yushun Tang, Yijia Wang, Zhihan Zhu, Zhihai He

16. [Granular Ball Guided Stable Latent Domain Discovery for Domain-General Crowd Counting](#link16)
**Authors:** Fan Chen, Shuyin Xia, Yi Wang, Xinbo Gao

17. [Semantic Iterative Reconstruction: One-Shot Universal Anomaly Detection](#link17)
**Authors:** Ning Zhu

18. [Bi-CRCL: Bidirectional Conservative-Radical Complementary Learning with Pre-trained Foundation Models for Class-incremental Medical Image Analysis](#link18)
**Authors:** Xinyao Wu, Zhe Xu, Cheng Chen, Jiawei Ma, Yefeng Zheng, Raymond Kai-yu Tong

19. [SemLayer: Semantic-aware Generative Segmentation and Layer Construction for Abstract Icons](#link19)
**Authors:** Haiyang Xu, Ronghuan Wu, Li-Yi Wei, Nanxuan Zhao, Chenxi Liu, Cuong Nguyen, Zhuowen Tu, Zhaowen Wang

20. [DB SwinT: A Dual-Branch Swin Transformer Network for Road Extraction in Optical Remote Sensing Imagery](#link20)
**Authors:** Zongyang He, Xiangli Yang, Xian Gao, Zhiguo Wang

21. [EnvSocial-Diff: A Diffusion-Based Crowd Simulation Model with Environmental Conditioning and Individual-Group Interaction](#link21)
**Authors:** Bingxue Zhao, Qi Zhang, Hui Huang

22. [3D-LLDM: Label-Guided 3D Latent Diffusion Model for Improving High-Resolution Synthetic MR Imaging in Hepatic Structure Segmentation](#link22)
...
23. [AMIF: Authorizable Medical Image Fusion Model with Built-in Authentication](#link23)
**Authors:** Jie Song, Jun Jia, Wei Sun, Wangqiu Zhou, Tao Tan, Guangtao Zhai

---
## 0. [VOLMO: Versatile and Open Large Models for Ophthalmology](https://arxiv.org/abs/2603.23953) <a id="link0"></a>
**ArXiv ID:** 2603.23953
**Authors:** Zhenyue Qin, Younjoon Chung, Elijah Lee, Wanyue Feng, Xuguang Ai, Serina Applebaum, Minjie Zou, Yang Liu, Pan Xiao, Mac Singer, Amisha Dave, Aidan Gilson, Tiarnan D. L. Keenan, Emily Y. Chew, Zhiyong Lu, Yih-Chung Tham, Ron Adelman, Luciano V. Del Priore, Qingyu Chen
...
**Comment:** Matches criterion 2 (Visual and Multimodal Large Language Models) and criterion 5 (Integration of Image/Video and Large Language Models) due to its focus on ophthalmology-specific multimodal large language models.
**Relevance:** 10
**Novelty:** 8

---

## 1. [CliPPER: Contextual Video-Language Pretraining on Long-form Intraoperative Surgical Procedures for Event Recognition](https://arxiv.org/abs/2603.24539) <a id="link1"></a>
**ArXiv ID:** 2603.24539
**Authors:** Florian Stilz, Vinkle Srivastav, Nassir Navab, Nicolas Padoy
...
**Comment:** Matches criteria 2 as it explores a novel video-language pretraining framework for fine-grained temporal video-text recognition, which aligns with advancements in multimodal large language models.
**Relevance:** 9
**Novelty:** 8

---

## 2. [COVTrack++: Learning Open-Vocabulary Multi-Object Tracking from Continuous Videos via a Synergistic Paradigm](https://arxiv.org/abs/2603.24016) <a id="link2"></a>
**ArXiv ID:** 2603.24016
**Authors:** Zekun Qian, Wei Feng, Ruize Han, Junhui Hou
...
**Comment:** Matches criterion 6 (Video Understanding) due to its focus on open-vocabulary multi-object tracking in videos.
**Relevance:** 9
**Novelty:** 7

---

## 3. [Attention-aware Inference Optimizations for Large Vision-Language Models with Memory-efficient Decoding](https://arxiv.org/abs/2603.23914) <a id="link3"></a>
**ArXiv ID:** 2603.23914
**Authors:** Fatih Ilhan, Gaowen Liu, Ramana Rao Kompella, Selim Furkan Tekin, Tiansheng Huang, Zachary Yahn, Yichang Xu, Ling Liu
...
**Comment:** Matches criterion 2 (Visual and Multimodal Large Language Models) due to its focus on optimizing inference for large vision-language models.
**Relevance:** 9
**Novelty:** 7

---

## 4. [Le MuMo JEPA: Multi-Modal Self-Supervised Representation Learning with Learnable Fusion Tokens](https://arxiv.org/abs/2603.24327) <a id="link4"></a>
**ArXiv ID:** 2603.24327
**Authors:** Ciem Cornelissen, Sam Leroux, Pieter Simoens
...
**Comment:** Matches criteria 5 as it presents a self-supervised framework combining image and LiDAR depth modalities, showcasing integration of image understanding tasks with multimodal learning.
**Relevance:** 8
**Novelty:** 7

---

## 5. [LongTail Driving Scenarios with Reasoning Traces: The KITScenes LongTail Dataset](https://arxiv.org/abs/2603.23607) <a id="link5"></a>
**ArXiv ID:** 2603.23607
**Authors:** Royden Wagner, Omer Sahin Tas, Jaime Villa, Felix Hauser, Yinzhe Shen, Marlon Steiner, Dominik Strutz, Carlos Fernandez, Christian Kinzig, Guillermo S. Guitierrez-Cabello, Hendrik K\"onigshof, Fabian Immel, Richard Schwarzkopf, Nils Alexander Rack, Kevin R\"osch, Kaiwen Wang, Jan-Hendrik Pauls, Martin Lauer, Igor Gilitschenski, Holger Caesar, Christoph Stiller
...
**Comment:** Matches criteria 3 as it introduces a new dataset and benchmark for long-tail driving scenarios, focusing on multimodal reasoning and generalization, which is relevant to embodied/robotic AI.
**Relevance:** 8
**Novelty:** 7

---

## 6. [Toward Physically Consistent Driving Video World Models under Challenging Trajectories](https://arxiv.org/abs/2603.24506) <a id="link6"></a>
**ArXiv ID:** 2603.24506
**Authors:** Jiawei Zhou, Zhenxin Zhu, Lingyi Du, Linye Lyu, Lijun Zhou, Zhanqian Wu, Hongcheng Luo, Zhuotao Tian, Bing Wang, Guang Chen, Hangjun Ye, Haiyang Sun, Yu Li
...
**Comment:** Matches criteria 3 as it introduces a novel method for generating physically consistent driving videos under challenging trajectories, which is relevant to embodied/robotic AI.
**Relevance:** 8
**Novelty:** 7

---

## 7. [MLE-UVAD: Minimal Latent Entropy Autoencoder for Fully Unsupervised Video Anomaly Detection](https://arxiv.org/abs/2603.23868) <a id="link7"></a>
**ArXiv ID:** 2603.23868
**Authors:** Yuang Geng, Junkai Zhou, Kang Yang, Pan He, Zhuoyang Zhou, Jose C. Principe, Joel Harley, Ivan Ruchkin
...
**Comment:** Matches criterion 6 (Video Understanding) due to its focus on video anomaly detection and novel unsupervised methods.
**Relevance:** 8
**Novelty:** 7

---

## 8. [VFIG: Vectorizing Complex Figures in SVG with Vision-Language Models](https://arxiv.org/abs/2603.24575) <a id="link8"></a>
**ArXiv ID:** 2603.24575
**Authors:** Qijia He, Xunmei Liu, Hammaad Memon, Ziang Li, Zixian Ma, Jaemin Cho, Jason Ren, Daniel S Weld, Ranjay Krishna
...
**Comment:** Matches criterion 5. Proposes a vision-language model for converting rasterized figures to SVG, integrating image understanding and generation tasks.
**Relevance:** 8
**Novelty:** 7

---

## 9. [Knowledge-Refined Dual Context-Aware Network for Partially Relevant Video Retrieval](https://arxiv.org/abs/2603.23902) <a id="link9"></a>
**ArXiv ID:** 2603.23902
**Authors:** Junkai Yang, Qirui Wang, Yaoqing Jin, Shuai Ma, Minghan Xu, Shanmin Pang
...
**Comment:** Matches criterion 6 (Video Understanding) due to its focus on video retrieval and addressing challenges in video-text alignment.
**Relevance:** 8
**Novelty:** 6

---

## 10. [MMTIT-Bench: A Multilingual and Multi-Scenario Benchmark with Cognition-Perception-Reasoning Guided Text-Image Machine Translation](https://arxiv.org/abs/2603.23896) <a id="link10"></a>
**ArXiv ID:** 2603.23896
**Authors:** Gengluo Li, Chengquan Zhang, Yupu Liang, Huawen Shen, Yaping Zhang, Pengyuan Lyu, Weinong Wang, Xingyu Wan, Gangyan Zeng, Han Hu, Can Ma, Yu Zhou
...
**Comment:** Matches criterion 2. Proposes a multilingual and multi-scenario benchmark for text-image machine translation and explores reasoning-oriented data design.
**Relevance:** 7
**Novelty:** 7

---

## 11. [UW-VOS: A Large-Scale Dataset for Underwater Video Object Segmentation](https://arxiv.org/abs/2603.24006) <a id="link11"></a>
**ArXiv ID:** 2603.24006
**Authors:** Hongshen Zhao, Jingkang Tai, Yuhang Wu, Wenkang Zhang, Xi Lan, Shangyan Wang, Tianyu Zhang, Wankou Yang
...
**Comment:** Matches criteria 6 as it introduces a large-scale dataset for underwater video object segmentation, which is a video understanding task.
**Relevance:** 7
**Novelty:** 6

---

## 12. [Towards Real-World Document Parsing via Realistic Scene Synthesis and Document-Aware Training](https://arxiv.org/abs/2603.23885) <a id="link12"></a>
**ArXiv ID:** 2603.23885
**Authors:** Gengluo Li, Chengquan Zhang, Yupu Liang, Huawen Shen, Yaping Zhang, Pengyuan Lyu, Weinong Wang, Xingyu Wan, Gangyan Zeng, Han Hu, Can Ma, Yu Zhou
...
**Comment:** Matches criterion 2. Focuses on document parsing using multimodal large language models and introduces new data and training strategies.
**Relevance:** 7
**Novelty:** 6

---

## 13. [SynMVCrowd: A Large Synthetic Benchmark for Multi-view Crowd Counting and Localization](https://arxiv.org/abs/2603.23956) <a id="link13"></a>
**ArXiv ID:** 2603.23956
**Authors:** Qi Zhang, Daijie Chen, Yunfei Gong, Hui Huang
...
**Comment:** Matches criterion 3. Introduces a large synthetic benchmark for multi-view crowd counting and localization.
**Relevance:** 6
**Novelty:** 6

---

## 14. [VehicleMemBench: An Executable Benchmark for Multi-User Long-Term Memory in In-Vehicle Agents](https://arxiv.org/abs/2603.23840) <a id="link14"></a>
**ArXiv ID:** 2603.23840
**Authors:** Yuhao Chen, Yi Xu, Xinyun Ding, Xiang Fang, Shuochen Liu, Luxi Lin, Qingyu Zhang, Ya Li, Quan Liu, Tong Xu
...
**Comment:** Matches criterion 3. Introduces a new benchmark for multi-user long-term memory in in-vehicle agents.
**Relevance:** 5
**Novelty:** 6

---

## 15. [Latent Bias Alignment for High-Fidelity Diffusion Inversion in Real-World Image Reconstruction and Manipulation](https://arxiv.org/abs/2603.23903) <a id="link15"></a>
**ArXiv ID:** 2603.23903
**Authors:** Weiming Chen, Qifan Liu, Siyi Liu, Yushun Tang, Yijia Wang, Zhihan Zhu, Zhihai He
...
## 16. [Granular Ball Guided Stable Latent Domain Discovery for Domain-General Crowd Counting](https://arxiv.org/abs/2603.24106) <a id="link16"></a>
**ArXiv ID:** 2603.24106
**Authors:** Fan Chen, Shuyin Xia, Yi Wang, Xinbo Gao
...
## 17. [Semantic Iterative Reconstruction: One-Shot Universal Anomaly Detection](https://arxiv.org/abs/2603.23766) <a id="link17"></a>
**ArXiv ID:** 2603.23766
**Authors:** Ning Zhu
...
## 18. [Bi-CRCL: Bidirectional Conservative-Radical Complementary Learning with Pre-trained Foundation Models for Class-incremental Medical Image Analysis](https://arxiv.org/abs/2603.23729) <a id="link18"></a>
**ArXiv ID:** 2603.23729
**Authors:** Xinyao Wu, Zhe Xu, Cheng Chen, Jiawei Ma, Yefeng Zheng, Raymond Kai-yu Tong
...
## 19. [SemLayer: Semantic-aware Generative Segmentation and Layer Construction for Abstract Icons](https://arxiv.org/abs/2603.24039) <a id="link19"></a>
**ArXiv ID:** 2603.24039
**Authors:** Haiyang Xu, Ronghuan Wu, Li-Yi Wei, Nanxuan Zhao, Chenxi Liu, Cuong Nguyen, Zhuowen Tu, Zhaowen Wang
...
**Comment:** Does not match any specific criteria. Focuses on semantic layer construction for vector graphics.
**Relevance:** 3
**Novelty:** 5

---

## 20. [DB SwinT: A Dual-Branch Swin Transformer Network for Road Extraction in Optical Remote Sensing Imagery](https://arxiv.org/abs/2603.24005) <a id="link20"></a>
**ArXiv ID:** 2603.24005
**Authors:** Zongyang He, Xiangli Yang, Xian Gao, Zhiguo Wang
...
**Comment:** Does not match any specific criteria. Focuses on road extraction in remote sensing imagery using a dual-branch Swin Transformer.
**Relevance:** 3
**Novelty:** 5

---

## 21. [EnvSocial-Diff: A Diffusion-Based Crowd Simulation Model with Environmental Conditioning and Individual-Group Interaction](https://arxiv.org/abs/2603.23874) <a id="link21"></a>
**ArXiv ID:** 2603.23874
**Authors:** Bingxue Zhao, Qi Zhang, Hui Huang
...
**Comment:** Does not match any specific criteria. Focuses on crowd simulation using diffusion models with environmental conditioning.
**Relevance:** 3
**Novelty:** 5

---

## 22. [3D-LLDM: Label-Guided 3D Latent Diffusion Model for Improving High-Resolution Synthetic MR Imaging in Hepatic Structure Segmentation](https://arxiv.org/abs/2603.23845) <a id="link22"></a>
**ArXiv ID:** 2603.23845
**Authors:** Kyeonghun Kim, Jaehyeok Bae, Youngung Han, Joo Young Bae, Seoyoung Ju, Junsu Lim, Gyeongmin Kim, Nam-Joon Kim, Woo Kyoung Jeong, Ken Ying-Kai Liao, Won Jae Lee, Pa Hong, Hyuk-Jae Lee
...
**Comment:** Does not match any specific criteria. Focuses on medical imaging and synthetic data generation for segmentation tasks.
**Relevance:** 3
**Novelty:** 5

---

## 23. [AMIF: Authorizable Medical Image Fusion Model with Built-in Authentication](https://arxiv.org/abs/2603.24296) <a id="link23"></a>
**ArXiv ID:** 2603.24296
**Authors:** Jie Song, Jun Jia, Wei Sun, Wangqiu Zhou, Tao Tan, Guangtao Zhai
...
**Comment:** Does not match any specific criteria. Focuses on medical image fusion with built-in authentication mechanisms.
**Relevance:** 3
**Novelty:** 4
